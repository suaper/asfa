            ...
            <h4 class="titulo_fondo w_100">Situación administrativa a la fecha de corte</h4>
              ...
              <div class="row dos_items">
                  <div class="item-numero">
                      ...
                      <q-select rounded standout v-model="data.costoAtencionNoHospitalariaVih" :options="costoAtencionNoHospitalariaVih" label="Seleccionar" />
                  </div>
                  <div class="item-numero">
                      <label>9Costo total de la atención hospitalaria de la persona viviendo con VIH en relación con la atención del VIH:  </label>
                      <q-select rounded standout v-model="data.costoAtencionHospitalariaVih" :options="profilaxisCriptococoVih" label="Seleccionar" />
                  </div>
              </div>
              ...
              <div class="row dos_items">
                  <div class="item-numero">
                      ...
                      <q-select rounded standout v-model="data.hospitalizacionesConVih" :options="hospitalizacionesConVih" label="Seleccionar" />
                  </div>
                  <div class="item">
              ...
              <div class="row dos_items">
                  ...
                  <div class="item-numero">
                      ...
                      <q-select rounded standout v-model="data.codigoUnicoo" :options="codigoUnicoo" label="Seleccionar" />
                  </div>
              </div>              
