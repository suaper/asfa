          ...
          <div class="wrp_forms w_73">
              <div class="row un_item">
                  <div class="item">
                      ...
                      <q-select rounded standout v-model="data.pregnantWoman" :options="pregnantWomans" :rules="[val => !!val || 'Campo requerido']" label="Seleccionar" />
                  </div>
              </div>
              <div class="row un_item" v-if="data.pregnantWoman.id !=='3' && data.pregnantWoman.id !== '9'">
                  <div class="item">
                    <label>FUM (Fecha de última menstruación confiable)</label>
                      <q-input filled v-model="data.fum" :rules="['date']">
              ...
              <!--<div class="row dos_items">
                  <div class="item">
                      ...
                      <q-select rounded standout v-model="model" :options="options" label="Seleccionar" :rules="[val => !!val || 'Campo requerido']"/>
                  </div>
                  <div class="item">
              ...
              <div class="row dos_items" v-if="data.pregnantWoman.id !=='3' && data.pregnantWoman.id !== '9'">
                  <div class="item">
                      ...
                      <q-input filled v-model="data.dateReportedPregnancy" :rules="['date']">
                          <template v-slot:append>
                          <q-icon name="event" class="cursor-pointer">
                  ...
                  <div class="item">
                      ...
                      <q-input filled v-model="data.dateScreeningFirst" :rules="['date']">
                          <template v-slot:append>
                          <q-icon name="event" class="cursor-pointer">
                              <q-popup-proxy cover transition-show="scale" transition-hide="scale">
              ...
              <div class="row dos_items" v-if="data.pregnantWoman.id !=='3' && data.pregnantWoman.id !== '9'">
                  <div class="item">
                      ...
                      <q-input filled v-model="data.dateScreeningSecond" :rules="['date']">
                          <template v-slot:append>
                          <q-icon name="event" class="cursor-pointer">
                              <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                  ...
                  <div class="item">
                      ...
                      <q-input filled v-model="data.dateScreeningThird" :rules="['date']">
                          <template v-slot:append>
                          <q-icon name="event" class="cursor-pointer">
                              <q-popup-proxy cover transition-show="scale" transition-hide="scale">
              ...
              <div class="row un_item" v-if="data.pregnantWoman.id !=='3' && data.pregnantWoman.id !== '9'">
                  <div class="item">
                    <label>Fecha de realización de tamizaje para VIH en el momento del parto</label>
                      <q-input filled v-model="data.dateScreeningBirth" :rules="['date']">
                          <template v-slot:append>
                          <q-icon name="event" class="cursor-pointer">
                              <q-popup-proxy cover transition-show="scale" transition-hide="scale">
              ...
              <div class="row dos_items" v-if="data.pregnantWoman.id !=='3' && data.pregnantWoman.id !== '9'">
                  <div class="item">
                      ...
                      <q-select rounded standout v-model="data.womanVihReported" :options="womanVihReporteds" label="Seleccionar" :rules="[val => !!val || 'Campo requerido']"/>
                  </div>
                  <div class="item">
                      <label>Edad gestacional al momento del diagnóstico de VIH durante la gestación reportada.</label>
                      <q-select rounded standout v-model="data.ageVihReported" :options="ageVihReported" label="Seleccionar" :rules="[val => !!val || 'Campo requerido']"/>
                  </div>
              </div>
              <div class="row dos_items" v-if="data.pregnantWoman.id !=='3' && data.pregnantWoman.id !== '9'">
                  <div class="item">
                      <label>¿Recibió tratamiento para VIH durante la gestación reportada?</label>
                      <q-select rounded standout v-model="data.receivedTreatmentVih" :options="receivedTreatmentVihs" label="Seleccionar" :rules="[val => !!val || 'Campo requerido']"/>
                  </div>
                  <div class="item">
                      <label>Edad gestacional al inicio de la terapia antirretroviral (TAR) en la gestación reportada.</label>
                      <q-select rounded standout v-model="data.ageInitTar" :options="ageInitTars" label="Seleccionar" :rules="[val => !!val || 'Campo requerido']"/>
                  </div>
              </div>
              <div class="row dos_items" v-if="data.pregnantWoman.id !=='3' && data.pregnantWoman.id !== '9'">
                  <div class="item">
                      <label>Terapia antirretroviral (TAR) durante el intraparto en la gestación reportada.</label>
                      <q-select rounded standout v-model="data.tarIntraBirth" :options="tarIntraBirths" label="Seleccionar" :rules="[val => !!val || 'Campo requerido']"/>
                  </div>
                  <div class="item">
                      <label>Resultado de la gestación reportada en gestantes con VIH</label>
                      <q-select rounded standout v-model="data.resultVihReported" :options="resultVihReporteds" label="Seleccionar" :rules="[val => !!val || 'Campo requerido']"/>
                  </div>
              </div>
              <div class="row un_item" v-if="data.pregnantWoman.id !=='3' && data.pregnantWoman.id !== '9'">
                  <div class="item">
                      <label>Fecha de culminación de la gestación reportada en gestantes con VIH.</label>
                      <q-input filled v-model="data.dateCulminationReported" :rules="['date']">
                          <template v-slot:append>
                          <q-icon name="event" class="cursor-pointer">
                              <q-popup-proxy cover transition-show="scale" transition-hide="scale">
              ...
              <div class="row dos_items" v-if="data.pregnantWoman.id !=='3' && data.pregnantWoman.id !== '9'">
                  <div class="item">
                      ...
                      <q-select rounded standout v-model="data.pharmacologicalSuppression" :options="pharmacologicalSuppressions" label="Seleccionar" :rules="[val => !!val || 'Campo requerido']"/>
                  </div>
                  <div class="item">
                      <label>Tipo de identificación del recién nacido vivo expuesto al VIH resultado de la gestación reportada.</label>
                      <q-select rounded standout v-model="data.identificationTypeNewbor" :options="identificationsNewbord" label="Seleccionar" :rules="[val => !!val || 'Campo requerido']"/>
                  </div>
              </div>
              <div class="row un_item" v-if="data.pregnantWoman.id !=='3' && data.pregnantWoman.id !== '9'">
                  <div class="item">
