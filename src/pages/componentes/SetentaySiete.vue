            ...
            <h4 class="titulo_fondo w_100">Terapia Antirretroviral (TAR) Actual</h4>
              ...
              <div class="row dos_items">
                  <div class="item-numero">
                      ...
                      <q-select rounded standout v-model="data.medicamento1TarActual" :options="medicamento1TarActual" label="Seleccionar" />
                  </div>
                  <div class="item-numero">
                      <label>Medicamento 2 de la TAR actual:</label>
                      <q-select rounded standout v-model="data.medicamento2TarActual" :options="medicamento2TarActual" label="Seleccionar" />
                  </div>
              </div>
              ...
              <div class="row dos_items">
                  <div class="item-numero">
                      ...
                      <q-select rounded standout v-model="data.medicamento3TarActual" :options="medicamento3TarActual" label="Seleccionar" />
                  </div>
                  <div class="item-numero">
                      <label>Medicamento 4 de la TAR actual:</label>
                      <q-select rounded standout v-model="data.medicamento4TarActual" :options="medicamento4TarActual" label="Seleccionar" />
                  </div>
              </div>
              ...
              <div class="row dos_items">
                  <div class="item-numero">
                      ...
                      <q-select rounded standout v-model="data.medicamento5TarActual" :options="medicamento5TarActual" label="Seleccionar" />
                  </div>
                  <div class="item-numero">
                      <label>Medicamento 6 de la TAR actual:</label>
                      <q-select rounded standout v-model="data.medicamento6TarActual" :options="medicamento6TarActual" label="Seleccionar" />
                  </div>
              </div>
              ...
              <div class="row uno_items">
                  <div class="item-numero">
                      ...
                      <q-select rounded standout v-model="data.mesesDispensoFormulaTar" :options="mesesDispensoFormulaTar" label="Seleccionar" />
                  </div>
              </div>
