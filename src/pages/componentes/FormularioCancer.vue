        ...
        <div class="wrp_forms w_50" v-if="firstStep">
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v21" :options="v21" label="Seleccionar" />
              </div>
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v22" :options="v22" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              ...
              <div class="item">
                  <label>24. Fecha de primero o único informe histopatológico válido de diagnóstico: </label>
                    <q-input filled v-model="data.v24">
                      <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy cover transition-show="scale" mask="YYYY-MM-DD" transition-hide="scale">
                          <q-date v-model="data.v24">
                              <div class="row items-center justify-end">
                              <q-btn v-close-popup label="Cerrar" color="primary" flat />
                              </div>
                          </q-date>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v25" :options="v25" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>26. Fecha de primera consulta con médico tratante de la enfermedad maligna </label>
                    <q-input filled v-model="data.v26">
                      <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy cover transition-show="scale" mask="YYYY-MM-DD" transition-hide="scale">
                          <q-date v-model="data.v26">
                              <div class="row items-center justify-end">
                              <q-btn v-close-popup label="Cerrar" color="primary" flat />
                              </div>
                          </q-date>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v27" :options="v27" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>28. Grado de diferenciación del tumor sólido maligno según la biopsia o informe de primera cirugía:  </label>
                  <q-select rounded standout v-model="data.v28" :options="v28" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row un_item">
              <div class="item">
                ...
                <q-select rounded standout v-model="data.v29" :options="v29" label="Seleccionar" />
              </div>
            </div>

            <div class="row un_item" v-if="typeof data.v29 !== 'undefined' && data.v29.id !== ''">
              <div class="item" v-if="data.v29.id === 'CÁNCER DE MAMA Y CÁNCER GÁSTRICO'">
              ...
              <div class="item" v-if="data.v29.id === 'CANCER DE PRÓSTATA'">
              ...
              <div class="item" v-if="data.v29.id === 'CANCER DE PULMON'">
              ...
              <div class="item" v-if="data.v29.id === 'CÁNCER ANAL (Agrupador Colon y recto)'">
              ...
              <div class="item" v-if="data.v29.id === 'CÁNCER DE CÉRVIX (FIGO)'">
              ...
              <div class="item" v-if="data.v29.id === 'OTRAS OPCIONES'">
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v31" :options="v31" label="Seleccionar" />
              </div>
              <div class="item">
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v33" :options="v33" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>34. Para cáncer colorrectal, estadificación de Dukes </label>
                  <q-select rounded standout v-model="data.v34" :options="v34" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  <label>35. Fecha en que se realizó la estadificación de Dukes: </label>
                    <q-input filled v-model="data.v35">
                      <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy cover transition-show="scale" mask="YYYY-MM-DD" transition-hide="scale">
                          <q-date v-model="data.v35">
                              <div class="row items-center justify-end">
                              <q-btn v-close-popup label="Cerrar" color="primary" flat />
                              </div>
                          </q-date>
              ...
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v36" :options="v36" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v37" :options="v37" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>38. Clasificación del riesgo leucemias o linfomas (para toda la población), y sólidos pediátricos: </label>
                  <q-select rounded standout v-model="data.v38" :options="v38" label="Seleccionar" />
              </div>
          </div>

          <div class="row un_item" v-if="typeof data.v38 !== 'undefined' && data.v38.id !== ''">
            <div class="item" v-if="data.v38.id === 'Clasificación de riesgo en linfoma no Hodgkin'">
            ...
            <div class="item" v-if="data.v38.id === 'Clasificación de riesgo en linfoma de Hodgkin'">
          ...
          <div class="row un_item" v-if="typeof data.v38 !== 'undefined' && data.v38.id !== ''">
            <div class="item" v-if="data.v38.id === 'Clasificación del riesgo en adultos (LLA y LMA)'">
            ...
            <div class="item" v-if="data.v38.id === 'Clasificación del riesgo en Pediatría (LLA y LMA)'">
          ...
          <div class="row dos_items">
              <div class="item">
                  <label>39. Fecha de clasificación de riesgo: </label>
                    <q-input filled v-model="data.v39">
                      <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy cover transition-show="scale" mask="YYYY-MM-DD" transition-hide="scale">
                          <q-date v-model="data.v39">
                              <div class="row items-center justify-end">
                              <q-btn v-close-popup label="Cerrar" color="primary" flat />
                              </div>
                          </q-date>
              ...
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v40" :options="v40" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row un_item">
              <div class="item">
                ...
                <q-input filled v-model="data.v41" />
              </div>
          </div>
          ...
          <div class="row dos_items">
            <div class="item numero">
                <label>42. Tiene antecedente o padece de otro cáncer primario (es decir, tiene o tuvo otro tumor maligno diferente al que está notificando): </label>
                  <q-select rounded standout v-model="data.v42" :options="v42" label="Seleccionar" />
            </div>
            <div class="item">
                <label>43. Fecha de diagnóstico del otro cáncer primario: </label>
                  <q-input filled v-model="data.v43">
                    <template v-slot:append>
                    <q-icon name="event" class="cursor-pointer">
                        <q-popup-proxy cover transition-show="scale" mask="YYYY-MM-DD" transition-hide="scale">
                        <q-date v-model="data.v43">
                            <div class="row items-center justify-end">
                            <q-btn v-close-popup label="Cerrar" color="primary" flat />
                            </div>
                        </q-date>
          ...
          <div class="row uno_items">
              <div class="item numero">
                  <label>44. Tipo (CIE-10) de ese cáncer antecedente o concurrente</label>
                    <q-select rounded standout v-model="data.v44" :options="v44" label="Seleccionar" />
              </div>
          </div>
          <div class="row dos_items">
              <div class="row actions cien q-mt-xl">
        ...
        <div class="wrp_forms w_50" v-if="thirdStep">
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v45" :options="v45" label="Seleccionar" />
              </div>
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v46" :options="v46" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v46_1" :options="v46_1" label="Seleccionar" />
              </div>
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v46_2" :options="v46_2" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v46_3" :options="v46_3" label="Seleccionar" />
              </div>
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v46_4" :options="v46_4" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  v<q-select rounded standout v-model="data.v46_5" :options="v46_5" label="Seleccionar" />
              </div>
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v46_6" :options="v46_6" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v46_7" :options="v46_7" label="Seleccionar" />
              </div>
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v46_8" :options="v46_8" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item numero">
                  <label>47. Número de ciclos iniciados y administrados en el periodo de reporte, incluyendo el que aún recibe en la fecha de finalización del periodo (aplica para todos los cánceres): </label>
                    <q-input rounded standout v-model="data.v47" lazy-rules type="number"></q-input>
              </div>
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v48" :options="v48" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  <label>49. Fecha de inicio del primer o único esquema de quimioterapia o terapia sistémica que recibió en este periodo. Este esquema pudo haber sido iniciado antes de periodo de reporte. </label>
                    <q-input filled v-model="data.v49">
                      <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy cover transition-show="scale" mask="YYYY-MM-DD" transition-hide="scale">
                          <q-date v-model="data.v49">
                              <div class="row items-center justify-end">
                              <q-btn v-close-popup label="Cerrar" color="primary" flat />
                              </div>
                          </q-date>
              ...
              <div class="item">
                  <label>50. Número de IPS que suministran el primer o único esquema de quimioterapia o terapia sistémica de este periodo de reporte:  </label>
                    <q-input rounded standout v-model="data.v50" lazy-rules type="number"></q-input>
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  <label>51. Código de la IPS1 que suministra el primer o único esquema de quimioterapia o terapia sistémica de este periodo de reporte</label>
                    <q-input rounded standout v-model="data.v51" lazy-rules type="number"></q-input>
              </div>
              <div class="item">
                  <label>52. Código de la IPS2 que suministra el primer o único esquema de quimioterapia o terapia sistémica de este periodo de reporte:  </label>
                    <q-input rounded standout v-model="data.v52" lazy-rules type="number"></q-input>
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  <label>53. Cuantos medicamentos antineoplásicos o terapia hormonal, el (los) especialista(s) tratante(s) del cáncer propusieron como manejo en el primer o único esquema de quimioterapia o terapia sistémica de este periodo de reporte</label>
                    <q-input rounded standout v-model="data.v53" lazy-rules type="number"></q-input>
              </div>
              <div class="item">
                  <label>53.1 Medicamento antineoplásico administrado al usuario- PRIMER o único esquema del periodo de reporte.(1) </label>
                    <q-select rounded standout v-model="data.v53_1" :options="v53_1" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  <label>53.2 Medicamento antineoplásico administrado al usuario- PRIMER o único esquema del periodo de reporte.(2) </label>
                    <q-select rounded standout v-model="data.v53_2" :options="v53_2" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>53.3 Medicamento antineoplásico administrado al usuario- PRIMER o único esquema del periodo de reporte.(3) </label>
                    <q-select rounded standout v-model="data.v53_3" :options="v53_3" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  <label>53.4 Medicamento antineoplásico administrado al usuario- PRIMER o único esquema del periodo de reporte.(4) </label>
                    <q-select rounded standout v-model="data.v53_4" :options="v53_4" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>53.5 Medicamento antineoplásico administrado al usuario- PRIMER o único esquema del periodo de reporte.(5) </label>
                    <q-select rounded standout v-model="data.v53_5" :options="v53_5" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  <label>53.6 Medicamento antineoplásico administrado al usuario- PRIMER o único esquema del periodo de reporte.(6) </label>
                    <q-select rounded standout v-model="data.v53_6" :options="v53_6" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>53.7 Medicamento antineoplásico administrado al usuario- PRIMER o único esquema del periodo de reporte.(7) </label>
                    <q-select rounded standout v-model="data.v53_7" :options="v53_7" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  <label>53.8 Medicamento antineoplásico administrado al usuario- PRIMER o único esquema del periodo de reporte.(8) </label>
                    <q-select rounded standout v-model="data.v53_8" :options="v53_8" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>53.9 Medicamento antineoplásico administrado al usuario- PRIMER o único esquema del periodo de reporte.(9) </label>
                    <q-select rounded standout v-model="data.v53_9" :options="v53_9" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  <label>54. Medicamento Antineoplásico o terapia hormonal para el cáncer, adicional a los reportados en las variables 53.1 a 53.9 - 1 administrado al usuario- primer o único esquema del periodo de reporte: </label>
                    <q-select rounded standout v-model="data.v54" :options="v54" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>55. Medicamento Antineoplásico o terapia hormonal para el cáncer, adicional a los reportados en las variables 53.1 a 53.9 - 2 administrado al usuario- primer o único esquema del periodo de reporte: </label>
                    <q-select rounded standout v-model="data.v55" :options="v55" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  <label>56. Medicamento Antineoplásico o terapia hormonal para el cáncer, adicional a los reportados en las variables 53.1 a 53.9 - 3 administrado al usuario- primer o único esquema del periodo de reporte: </label>
                    <q-select rounded standout v-model="data.v56" :options="v56" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>57. ¿Recibió quimioterapia intratecal en el primer o único esquema de este periodo de reporte?:</label>
                    <q-select rounded standout v-model="data.v57" :options="v57" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              ...
              <div class="item">
                  <label>59. Características actuales del primer o único esquema de este periodo de reporte:</label>
                    <q-select rounded standout v-model="data.v59" :options="v59" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  <label>60. Motivo de la finalización (prematura) de este primer o único esquema (Aplica si registró la opción 2 de la variable anterior). Seleccione un sólo número (lo que primero ocurrió):  </label>
                    <q-select rounded standout v-model="data.v60" :options="v60" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>61. Ubicación temporal del ÚLTIMO esquema de quimioterapia o terapia sistémica de este periodo de reporte en relación al manejo oncológico: </label>
                    <q-select rounded standout v-model="data.v61" :options="v61" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              ...
              <div class="item">
                  <label>63. Número de IPS que suministran el último esquema de este periodo de reporte: </label>
                    <q-input rounded standout v-model="data.v63" lazy-rules type="number"></q-input>
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  <label>64. Código de la IPS1 que suministra el último esquema en este periodo de reporte: </label>
                    <q-input rounded standout v-model="data.v64" lazy-rules type="number"></q-input>
              </div>
              <div class="item">
                  <label>65. Código de la IPS2 que suministra el último esquema en este periodo de reporte: </label>
                    <q-input rounded standout v-model="data.v65" lazy-rules type="number"></q-input>
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  <label>66. Cuantos medicamentos antineoplásicos o terapia hormonal, el (los) especialista(s) tratante(s) del cáncer propusieron como manejo en ÚLTIMO esquema de quimioterapia o terapia sistémica de este periodo de reporte: </label>
                    <q-input rounded standout v-model="data.v66" lazy-rules type="number"></q-input>
              </div>
              <div class="item">
          ...
          <div class="row dos_items">
              ...
              <div class="item">
                  <label>70. ¿Recibió quimioterapia intratecal en el último esquema de este periodo de reporte</label>
                    <q-select rounded standout v-model="data.v70" :options="v70" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  <label>71. Fecha de finalización del último esquema de quimioterapia o terapia sistémica este periodo de reporte. Si es hormonoterapia terminada o esquema terminado en este periodo reporte la fecha de finalización del tratamiento actual: </label>
                    <q-input filled v-model="data.v71">
                      <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy cover transition-show="scale" mask="YYYY-MM-DD" transition-hide="scale">
                          <q-date v-model="data.v71">
                              <div class="row items-center justify-end">
                              <q-btn v-close-popup label="Cerrar" color="primary" flat />
                              </div>
                          </q-date>
              ...
              <div class="item">
                  <label>72. Características actuales del último esquema de este periodo:</label>
                    <q-select rounded standout v-model="data.v72" :options="v72" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row un_item">
              <div class="item">
                  <label>73. Motivo de la finalización (prematura) de este último esquema (Aplica si registró la opción 2 de la pregunta anterior) Seleccione un sólo número (lo que primero ocurrió): </label>
                    <q-select rounded standout v-model="data.v73" :options="v73" label="Seleccionar" />
              </div>
          </div>
        <div class="row dos_items">
            <div class="row actions cien q-mt-xl">
        ...
        <div class="wrp_forms w_50" v-if="fourthStep">
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v74" :options="v74" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>75. Número de cirugías a las que fue sometido el usuario durante el periodo de reporte actual:  </label>
                    <q-input rounded standout v-model="data.v75" lazy-rules type="number"></q-input>
              </div>
          </div>
          ...
          <div class="row dos_items">
              ...
              <div class="item">
                  ...
                  <q-input rounded standout v-model="data.v77" lazy-rules type="number"></q-input>
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-input rounded standout v-model="data.v78" lazy-rules type="number"></q-input>
              </div>
              <div class="item">
                  <label>79. Ubicación temporal de esta primera cirugía en relación al manejo oncológico: </label>
                  <q-select rounded standout v-model="data.v79" :options="v79" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  <label>80. Fecha de realización de la última cirugía o cirugía de reintervención en este periodo de reporte:</label>
                    <q-input filled v-model="data.v80">
                      <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy cover transition-show="scale" mask="YYYY-MM-DD" transition-hide="scale">
                          <q-date v-model="data.v80">
                              <div class="row items-center justify-end">
                              <q-btn v-close-popup label="Cerrar" color="primary" flat />
                              </div>
                          </q-date>
              ...
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v81" :options="v81" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-input rounded standout v-model="data.v82" lazy-rules type="number"></q-input>
              </div>
              <div class="item">
                  <label>83. Código de última cirugía en este periodo de reporte:</label>
                  <q-input rounded standout v-model="data.v83" lazy-rules type="number"></q-input>
              </div>
          </div>
          ...
          <div class="row uno_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v84" :options="v84" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>85. Estado vital al finalizar la única o última cirugía de este periodo de reporte:</label>
                  <q-select rounded standout v-model="data.v85" :options="v85" label="Seleccionar" />
              </div>
          </div>
        ...
        <div class="wrp_forms w_50" v-if="fiveStep">
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v86" :options="v86" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>87. Número de sesiones de radioterapia recibidas en el periodo</label>
                    <q-input rounded standout v-model="data.v87" lazy-rules type="number"></q-input>
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  <label>88. Fecha de inicio de primer o único esquema de cualquier tipo de radioterapia suministrado en el periodo de reporte actual. Reporte la fecha de inicio del tratamiento actual, así haya sido iniciada previo al reporte actual: </label>
                    <q-input filled v-model="data.v88">
                      <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy cover transition-show="scale" mask="YYYY-MM-DD" transition-hide="scale">
                          <q-date v-model="data.v88">
                              <div class="row items-center justify-end">
                              <q-btn v-close-popup label="Cerrar" color="primary" flat />
                              </div>
                          </q-date>
              ...
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v89" :options="v89" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v90" :options="v90" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>91. Número de IPS que suministran este primer o único esquema de radioterapia: </label>
                    <q-input rounded standout v-model="data.v91" lazy-rules type="number"></q-input>
              </div>
          </div>
          ...
          <div class="row uno_items">
              <div class="item">
                  ...
                  <q-input rounded standout v-model="data.v92" lazy-rules type="number"></q-input>
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-input rounded standout v-model="data.v93" lazy-rules type="number"></q-input>
              </div>
              <div class="item">
                  <label>94. Fecha de finalización de primer o único esquema de radioterapia: </label>
                    <q-input filled v-model="data.v94">
                      <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy cover transition-show="scale" mask="YYYY-MM-DD" transition-hide="scale">
                          <q-date v-model="data.v94">
                              <div class="row items-center justify-end">
                              <q-btn v-close-popup label="Cerrar" color="primary" flat />
                              </div>
                          </q-date>
          ...
          <div class="row uno_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v95" :options="v95" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v96" :options="v96" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>97. Fecha de inicio del último esquema de cualquier tipo de radioterapia suministrado en el periodo de reporte actual: </label>
                    <q-input filled v-model="data.v97">
                      <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy cover transition-show="scale" mask="YYYY-MM-DD" transition-hide="scale">
                          <q-date v-model="data.v97">
                              <div class="row items-center justify-end">
                              <q-btn v-close-popup label="Cerrar" color="primary" flat />
                              </div>
                          </q-date>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v98" :options="v98" label="Seleccionar" />
              </div>
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v99" :options="v99" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-input rounded standout v-model="data.v100" lazy-rules type="number"></q-input>
              </div>
              <div class="item">
                  ...
                  <q-input rounded standout v-model="data.v101" lazy-rules type="number"></q-input>
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-input rounded standout v-model="data.v102" lazy-rules type="number"></q-input>
              </div>
              <div class="item">
                  <label>103. Fecha de finalización del último esquema de cualquier tipo de radioterapia suministrado en el periodo de reporte actual: </label>
                    <q-input filled v-model="data.v103">
                      <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy cover transition-show="scale" mask="YYYY-MM-DD" transition-hide="scale">
                          <q-date v-model="data.v103">
                              <div class="row items-center justify-end">
                              <q-btn v-close-popup label="Cerrar" color="primary" flat />
                              </div>
                          </q-date>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v104" :options="v104" label="Seleccionar" />
              </div>
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v105" :options="v105" label="Seleccionar" />
              </div>
          </div>
          <div class="row dos_items">
              <div class="row actions cien q-mt-xl">
        ...
        <div class="wrp_forms w_50" v-if="sixStep">
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v106" :options="v106" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>107. Tipo de trasplante recibido: </label>
                  <q-select rounded standout v-model="data.v107" :options="v107" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v108" :options="v108" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>109. Fecha del trasplante: </label>
                    <q-input filled v-model="data.v109">
                      <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy cover transition-show="scale" mask="YYYY-MM-DD" transition-hide="scale">
                          <q-date v-model="data.v109">
                              <div class="row items-center justify-end">
                              <q-btn v-close-popup label="Cerrar" color="primary" flat />
                              </div>
                          </q-date>
          ...
          <div class="row uno_items">
              <div class="item">
                  ...
                  <q-input rounded standout v-model="data.v110" lazy-rules type="number"></q-input>
              </div>
          </div>
        ...
        <div class="wrp_forms w_50" v-if="sevenStep">
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v111" :options="v111" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>112. Fecha de la cirugía reconstructiva:  </label>
                    <q-input filled v-model="data.v112">
                      <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy cover transition-show="scale" mask="YYYY-MM-DD" transition-hide="scale">
                          <q-date v-model="data.v112">
                              <div class="row items-center justify-end">
                              <q-btn v-close-popup label="Cerrar" color="primary" flat />
                              </div>
                          </q-date>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-input rounded standout v-model="data.v113" lazy-rules type="number"></q-input>
              </div>
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v114" :options="v114" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v114_1" :options="v114_1" label="Seleccionar" />
              </div>
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v114_2" :options="v114_2" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v114_3" :options="v114_1" label="Seleccionar" />
              </div>
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v114_4" :options="v114_1" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v114_5" :options="v114_1" label="Seleccionar" />
              </div>
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v114_6" :options="v114_6" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  <label>115. Fecha de primera consulta o procedimiento de cuidado paliativo en el periodo de reporte actual: </label>
                    <q-input filled v-model="data.v115">
                      <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy cover transition-show="scale" mask="YYYY-MM-DD" transition-hide="scale">
                          <q-date v-model="data.v115">
                              <div class="row items-center justify-end">
                              <q-btn v-close-popup label="Cerrar" color="primary" flat />
                              </div>
                          </q-date>
              ...
              <div class="item">
                  ...
                  <q-input rounded standout v-model="data.v116" lazy-rules type="number"></q-input>
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v117" :options="v117" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>118. Fecha de primera consulta con el servicio de psiquiatría (para todos los usuarios) en el periodo de reporte actual:  </label>
                    <q-input filled v-model="data.v118">
                      <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy cover transition-show="scale" mask="YYYY-MM-DD" transition-hide="scale">
                          <q-date v-model="data.v118">
                              <div class="row items-center justify-end">
                              <q-btn v-close-popup label="Cerrar" color="primary" flat />
                              </div>
                          </q-date>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-input rounded standout v-model="data.v119" lazy-rules type="number"></q-input>
              </div>
              <div class="item">
                  <label>120. ¿Fue valorado el usuario por profesional en nutrición en el periodo de reporte actual?: </label>
                  <q-select rounded standout v-model="data.v120" :options="v120" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  <label>121. Fecha de consulta inicial con nutrición en el periodo de reporte actual:  </label>
                    <q-input filled v-model="data.v121">
                      <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy cover transition-show="scale" mask="YYYY-MM-DD" transition-hide="scale">
                          <q-date v-model="data.v121">
                              <div class="row items-center justify-end">
                              <q-btn v-close-popup label="Cerrar" color="primary" flat />
                              </div>
                          </q-date>
              ...
              <div class="item">
                  ...
                  <q-input rounded standout v-model="data.v122" lazy-rules type="number"></q-input>
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v123" :options="v123" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>124. ¿El usuario ha recibido terapias complementarias para su rehabilitación? </label>
                  <q-select rounded standout v-model="data.v124" :options="v124" label="Seleccionar" />
              </div>
          </div>
        ...
        <div class="wrp_forms w_50" v-if="eightStep">
          ...
          <div class="row uno_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v125" :options="v125" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v126" :options="v126" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>127. Estado vital al finalizar este periodo de reporte:</label>
                  <q-select rounded standout v-model="data.v127" :options="v127" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v128" :options="v128" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>129. Novedad clínica del usuario a la fecha de corte:</label>
                  <q-select rounded standout v-model="data.v129" :options="v129" label="Seleccionar" />
              </div>
          </div>
          ...
          <div class="row dos_items">
              <div class="item">
                  <label>130. Fecha de desafiliación de la EAPB:</label>
                    <q-input filled v-model="data.v130">
                      <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy cover transition-show="scale" mask="YYYY-MM-DD" transition-hide="scale">
                          <q-date v-model="data.v130">
                              <div class="row items-center justify-end">
                              <q-btn v-close-popup label="Cerrar" color="primary" flat />
                              </div>
                          </q-date>
              ...
              <div class="item">
                  <label>131. Fecha de muerte</label>
                    <q-input filled v-model="data.v131">
                      <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy cover transition-show="scale" mask="YYYY-MM-DD" transition-hide="scale">
                          <q-date v-model="data.v131">
                              <div class="row items-center justify-end">
                              <q-btn v-close-popup label="Cerrar" color="primary" flat />
                              </div>
                          </q-date>
          ...
          <div class="row dos_items">
              <div class="item">
                  ...
                  <q-select rounded standout v-model="data.v132" :options="v132" label="Seleccionar" />
              </div>
              <div class="item">
                  <label>133. Código único de identificación (BDUA-BDEX-PVS): </label>
                  <q-input rounded standout v-model="data.v133" lazy-rules type="number"></q-input>
              </div>
          </div>
          ...
          <div class="row uno_items">
              <div class="item">
                  <label>134. Fecha de Corte: </label>
                    <q-input filled v-model="data.v134">
                      <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                          <q-popup-proxy cover transition-show="scale" mask="YYYY-MM-DD" transition-hide="scale">
                          <q-date v-model="data.v134">
                              <div class="row items-center justify-end">
                              <q-btn v-close-popup label="Cerrar" color="primary" flat />
                              </div>
                          </q-date>
...
export default {
  ...
  methods: {
    ...
    saveRegister () {
      ...
      console.log(this.filtrarPorV(_this.data))
      var cualquiera = JSON.stringify(this.filtrarPorV(_this.data))
      console.log(cualquiera) */

      if (this.status !== 'finalizado') {
        if (typeof this.data.v18 !== 'undefined' && this.data.v18 !== '1800-01-01' && typeof this.data.v18 !== 'undefined' && this.data.v18 !== '1846-01-01') {
        ...
        if (typeof this.data.v18 !== 'undefined' && this.data.v18 === '1800-01-01' && typeof this.data.v18 !== 'undefined' && this.data.v128.id !== '2') {
          this.errors.push('La V128 es <> 2 revisar la  V18 Debe ser = 1800-01-01')
          this.error = true
        }
        if (Date.parse(this.data.v18) >= Date.parse('2021-01-01') && this.data.v128.id !== '0' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '3') {
          this.errors.push('La V128 ES< >0 y <> 3  revisar La V18 Debe ser >= 2021-01-01')
          this.error = true
        }
        if (typeof this.data.v18 !== 'undefined' && this.data.v18 === '1846-01-01' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('la V128 es = 14 revisar La V18 Debe ser= 1846-01-01')
          this.error = true
        }
        if (typeof this.data.v18 !== 'undefined' && this.data.v18 === '1846-01-01' && Date.parse(this.data.v26) > Date.parse('2021-01-01')) {
          this.errors.push('La v26 es < 2021-01-01  revisar La V18 Debe ser= 1800-01-01')
          this.error = true
        }
        if (typeof this.data.v18 !== 'undefined' && this.data.v18 === '1846-01-01' && Date.parse(this.data.v30) > Date.parse('2021-01-01')) {
        ...
        if (typeof this.data.v19 !== 'undefined' && this.data.v19 !== '1800-01-01' && typeof this.data.v19 !== 'undefined' && this.data.v19 !== '1846-01-01') {
        ...
        if (typeof this.data.v19 !== 'undefined' && this.data.v19 === '1846-01-01' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 es = 154 revisar La V19 DEBE SER = 1846-01-01')
          this.error = true
        }
        if (typeof this.data.v19 !== 'undefined' && this.data.v19 === '1846-01-01' && typeof this.data.v128 !== 'undefined' && this.data.v128.id === '2') {
          this.errors.push('La V128 es <> 2 revisar La V19 DEBE SER = 1800-01-01')
          this.error = true
        }
        // 20

        if (typeof this.data.v20 !== 'undefined' && this.data.v20 !== '1800-01-01' && typeof this.data.v20 !== 'undefined' && this.data.v20 !== '1846-01-01') {
        ...
        if (typeof this.data.v20 !== 'undefined' && this.data.v20 === '1846-01-01' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
        ...
        if (typeof this.data.v21 !== 'undefined' && this.data.v21.id === '7' && typeof this.data.v24 !== 'undefined' && this.data.v24 === '1845-01-01') {
        ...
        if (typeof this.data.v21 !== 'undefined' && this.data.v21.id === '5' && typeof this.data.v23 !== 'undefined' && this.data.v23 === '1845-01-01') {
          this.errors.push('La V21 es =  5,6,8,9,o 10  revisar la V23 debe ser <> 1845-01-01')
          this.error = true
        }

        if (typeof this.data.v21 !== 'undefined' && this.data.v21.id === '5' && typeof this.data.v24 !== 'undefined' && this.data.v24 === '1845-01-01') {
          this.errors.push('La V21 es =  5,6,8,9,o 10  revisar la V22 debe ser<> 1845-01-01')
          this.error = true
        }

        if (typeof this.data.v21 !== 'undefined' && this.data.v21.id === '5' && typeof this.data.v27 !== 'undefined' && this.data.v27.id === '98') {
          this.errors.push('La V21 es =  5,6,8,9,o 10  revisar la V27debe ser  <> 98')
          this.error = true
        }

        if (typeof this.data.v21 !== 'undefined' && this.data.v21.id === '5' && typeof this.data.v28 !== 'undefined' && this.data.v28.id === '98') {
        ...
        if (typeof this.data.v21 !== 'undefined' && this.data.v21.id === '6' && typeof this.data.v23 !== 'undefined' && this.data.v23 === '1845-01-01') {
          this.errors.push('La V21 es =  5,6,8,9,o 10  revisar la V23 debe ser <> 1845-01-01')
          this.error = true
        }

        if (typeof this.data.v21 !== 'undefined' && this.data.v21.id === '6' && typeof this.data.v24 !== 'undefined' && this.data.v24 === '1845-01-01') {
          this.errors.push('La V21 es =  5,6,8,9,o 10  revisar la V22 debe ser<> 1845-01-01')
          this.error = true
        }
        ...
        if (typeof this.data.v21 !== 'undefined' && this.data.v21.id === '8' && typeof this.data.v23 !== 'undefined' && this.data.v23 === '1845-01-01') {
          this.errors.push('La V21 es =  5,6,8,9,o 10  revisar la V23 debe ser <> 1845-01-01')
          this.error = true
        }

        if (typeof this.data.v21 !== 'undefined' && this.data.v21.id === '8' && typeof this.data.v24 !== 'undefined' && this.data.v24 === '1845-01-01') {
          this.errors.push('La V21 es =  5,6,8,9,o 10  revisar la V22 debe ser<> 1845-01-01')
          this.error = true
        }
        ...
        if (typeof this.data.v21 !== 'undefined' && this.data.v21.id === '9' && typeof this.data.v23 !== 'undefined' && this.data.v23 === '1845-01-01') {
          this.errors.push('La V21 es =  5,6,8,9,o 10  revisar la V23 debe ser <> 1845-01-01')
          this.error = true
        }

        if (typeof this.data.v21 !== 'undefined' && this.data.v21.id === '9' && typeof this.data.v24 !== 'undefined' && this.data.v24 === '1845-01-01') {
          this.errors.push('La V21 es =  5,6,8,9,o 10  revisar la V22 debe ser<> 1845-01-01')
          this.error = true
        }
        ...
        if (typeof this.data.v21 !== 'undefined' && this.data.v21.id === '10') {
          ...
          if (typeof this.data.v23 !== 'undefined' && this.data.v23 !== '1845-01-01') {
            this.errors.push('La V21 es =  5,6,8,9,o 10  revisar la V23 debe ser <> 1845-01-01')
            this.error = true
          }
          if (typeof this.data.v24 !== 'undefined' && this.data.v24 !== '1845-01-01') {
            this.errors.push('La V21 es =  5,6,8,9,o 10  revisar la V22 debe ser<> 1845-01-01')
            this.error = true
          }
        ...
        // v23
        if (typeof this.data.v23 !== 'undefined' && this.data.v23 !== '1800-01-01' && typeof this.data.v23 !== 'undefined' && this.data.v23 !== '1845-01-01' && typeof this.data.v23 !== 'undefined' && this.data.v23 !== '1846-01-01') {
        ...
        if (typeof this.data.v23 !== 'undefined' && this.data.v23 === '1846-01-01' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 es = 14 y la V24 es 1846-01-01 revisar La V23 debe ser = 1846-01-01')
          this.error = true
        }

        if (typeof this.data.v23 !== 'undefined' && this.data.v23 === '1846-01-01' && typeof this.data.v24 !== 'undefined' && this.data.v24 !== '1846-01-01') {
          this.errors.push('La V24 es 1846-01-01 revisar La V23 debe ser = 1846-01-01')
          this.error = true
        }

        if (typeof this.data.v23 !== 'undefined' && this.data.v23 === '1845-01-01' && typeof this.data.v21 !== 'undefined' && this.data.v21.id !== '7') {
          this.errors.push('La V21 es 7 revisar La V23 debe ser = 1845-01-01')
          this.error = true
        }

        if (typeof Date.parse(this.data.v23) > Date.parse('2021-01-01') && typeof this.data.v128 !== 'undefined' && this.data.v128.id === '0') {
        ...
        if (typeof this.data.v24 !== 'undefined' && this.data.v24 !== '1800-01-01' && typeof this.data.v24 !== 'undefined' && this.data.v24 !== '1845-01-01' && typeof this.data.v24 !== 'undefined' && this.data.v24 !== '1846-01-01') {
        ...
        if (typeof this.data.v24 !== 'undefined' && this.data.v24 === '1846-01-01') {
        ...
        if (typeof this.data.v24 !== 'undefined' && this.data.v24 === '1800-01-01') {
        ...
        // 26
        if (typeof this.data.v26 !== 'undefined' && this.data.v26 === '1800-01-01' && typeof this.data.v26 !== 'undefined' && this.data.v26 === '1846-01-01') {
        ...
        if (typeof this.data.v27 !== 'undefined' && this.data.v27.id === '98' && typeof this.data.v23 !== 'undefined' && this.data.v23 !== '1845-01-01') {
          this.errors.push('La V23 es = 1845-01-01 revisaR La V27 debe ser = 98')
          this.error = true
        }
        if (typeof this.data.v27 !== 'undefined' && this.data.v27.id === '98' && typeof this.data.v24 !== 'undefined' && this.data.v24 !== '1845-01-01') {
        ...
        if (typeof this.data.v28 !== 'undefined' && this.data.V28.id === '98' && typeof this.data.v23 !== 'undefined' && this.data.V23 !== '1845-01-01') {
          this.errors.push('La V23 debe ser 1845-01-01, revisa La V28 debe ser 98')
          this.error = true
        }

        if (typeof this.data.v28 !== 'undefined' && this.data.V28.id === '98' && typeof this.data.v24 !== 'undefined' && this.data.V24 !== '1845-01-01') {
          this.errors.push('La V24 debe ser 1845-01-01, revisa La V28 debe ser 98')
          this.error = true
        }

        if (typeof this.data.v28 !== 'undefined' && this.data.v28.id < 5 && typeof this.data.v23 !== 'undefined' && this.data.v23 !== '1845-01-01') {
        ...
        if (typeof this.data.v30 !== 'undefined' && this.data.v30 !== '1845-01-01' && typeof this.data.v30 !== 'undefined' && this.data.v30 !== '1800-01-01' && typeof this.data.v30 !== 'undefined' && this.data.v30 !== '1846-01-01') {
          if (Date.parse(this.data.v30) <= Date.parse(this.data.v18)) {
            this.errors.push('La V30 DEBE SER >= V18')
            this.error = true
          }
        ...
        if (typeof this.data.v30 !== 'undefined' && this.data.v30 === '1845-01-01' && typeof this.data.v29 !== 'undefined' && this.data.v29.id !== '98') {
          this.errors.push('La V29 es = 98 revisar La V30 debe ser = 1845-01-01')
          this.error = true
        }

        if (typeof this.data.v30 !== 'undefined' && this.data.v30 === '1846-01-01' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
        ...
        if (typeof this.data.v31 !== 'undefined' && this.data.v31.id === '1' && typeof this.data.v32 !== 'undefined' && this.data.v32 === '1845-01-01') {
        ...
        if (typeof this.data.v31 !== 'undefined' && this.data.v31.id === '98' && typeof this.data.v32 !== 'undefined' && this.data.v32 !== '1845-01-01') {
        ...
        if (Date.parse(this.data.v32) > Date.parse('1846-01-01') && typeof this.data.v33 !== 'undefined' && this.data.v33.id >= '4') {
          this.errors.push('LA V33 es <= 4 revisar La V32 deb ser >1846-01-01')
          this.error = true
        }

        if (typeof this.data.v32 !== 'undefined' && this.data.v32 === '1840-01-01' && this.data.v17 !== 'D050') {
          this.errors.push('La V32 es =  1840-01-01 Revisar V17 debe ser D050, D051, D057 o D059')
          this.error = true
        }

        if (typeof this.data.v32 !== 'undefined' && this.data.v32 === '1840-01-01' && this.data.v17 !== 'D051') {
          this.errors.push('La V32 es =  1840-01-01 Revisar V17 debe ser D050, D051, D057 o D059')
          this.error = true
        }

        if (typeof this.data.v32 !== 'undefined' && this.data.v32 === '1840-01-01' && this.data.v17 !== 'D057') {
          this.errors.push('La V32 es =  1840-01-01 Revisar V17 debe ser D050, D051, D057 o D059')
          this.error = true
        }

        if (typeof this.data.v32 !== 'undefined' && this.data.v32 === '1840-01-01' && this.data.v17 !== 'D059') {
          this.errors.push('La V32 es =  1840-01-01 Revisar V17 debe ser D050, D051, D057 o D059')
          this.error = true
        }

        if (typeof this.data.v32 !== 'undefined' && this.data.v32 === '1840-01-01') {
        ...
        if (typeof this.data.v32 !== 'undefined' && this.data.v32 === '1845-01-01' && typeof this.data.v31 !== 'undefined' && this.data.v31.id !== '2') {
          this.errors.push('LA V32 es = 1845-01-01 revisar la V31 deb ser = 98 o 2')
          this.error = true
        }

        if (typeof this.data.v32 !== 'undefined' && this.data.v32 === '1845-01-01' && typeof this.data.v31 !== 'undefined' && this.data.v31.id !== '98') {
          this.errors.push('LA V32 es = 1845-01-01 revisar la V31 deb ser = 98 o 2')
          this.error = true
        }

        if (typeof this.data.v32 !== 'undefined' && this.data.v32 === '1846-01-01') {
          if (typeof this.data.v128 !== 'undefined' && this.data.V128.id !== '14') {
        ...
        if (typeof this.data.v32 !== 'undefined' && this.data.v32 === '1800-01-01') {
          if (typeof this.data.v128 !== 'undefined' && this.data.V128.id !== '2') {
        ...
        if (typeof this.data.v32 !== 'undefined' && typeof this.data.v134 !== 'undefined' && Date.parse(this.data.v32) >= Date.parse(this.data.v134)) {
        ...
        if (typeof this.data.v33 !== 'undefined' && this.data.v33.id === '97') {
          ...
          if (typeof this.data.v29 !== 'undefined' && this.data.v29 !== '0') {
        ...
        // 35
        if (typeof this.data.v35 !== 'undefined' && this.data.v35 !== '1845-01-01' && typeof this.data.v35 !== 'undefined' && this.data.v35 !== '1846-01-01') {
          if (typeof this.data.v35 !== 'undefined' && typeof this.data.v18 !== 'undefined' && Date.parse(this.data.v35) < Date.parse(this.data.v18)) {
            this.errors.push('La V35 DEBE SER >= V18')
            this.error = true
          }

          if (typeof this.data.v35 !== 'undefined' && typeof this.data.v134 !== 'undefined' && Date.parse(this.data.v35) > Date.parse(this.data.v134)) {
            this.errors.push('La V35 DEBE SER <= V134')
            this.error = true
          }
        }

        if (typeof this.data.v35 !== 'undefined' && this.data.v35 === '1845-01-01') {
        ...
        if (typeof this.data.v35 !== 'undefined' && this.data.v35 === '1846-01-01') {
          if (typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
        ...
        if (typeof this.data.v35 !== 'undefined' && Date.parse(this.data.v35) > Date.parse('1846-01-01') && typeof this.data.v35 !== 'undefined' && typeof this.data.v134 !== 'undefined' && Date.parse(this.data.v35) > Date.parse(this.data.v134)) {
          this.errors.push('La V134 debe ser >= La V35')
          this.error = true
        }

        if (typeof this.data.v35 !== 'undefined' && Date.parse(this.data.v35) > Date.parse('1846-01-01') && typeof this.data.v22 !== 'undefined' && parseInt(this.data.v34.id) > 4) {
        ...
        if (typeof this.data.v37 !== 'undefined' && this.data.v37 === '97' && typeof this.data.v21 !== 'undefined' && this.data.v21.id !== '7') {
          this.errors.push('La V37 es 97 revisar la V21 debe ser 7')
          this.error = true
        }

        if (typeof this.data.v37 !== 'undefined' && this.data.v37 === '97' && typeof this.data.v24 !== 'undefined' && this.data.v24 !== '1845-01-01') {
          this.errors.push('La V37 es 97 revisar la V24 debe ser 1845-01-01')
          this.error = true
        }

        // 38
        if (typeof this.data.v38 !== 'undefined' && this.data.v38.id === '98' && typeof this.data.v39 !== 'undefined' && this.data.v39 !== '1845-01-01') {
          this.errors.push('La fecha de V39 debe ser 1845-01-01')
          this.error = true
        }

        if (typeof this.data.v38 !== 'undefined' && this.data.v38.id !== '55' && typeof this.data.v38 !== 'undefined' && this.data.v38.id !== '98' && typeof this.data.v38 !== 'undefined' && this.data.v38.id !== '99') {
          this.errors.push('V38 debe ser igual a 55, 98 ó 99')
          this.error = true
        }

        if (this.data.v38.id !== '55' && this.data.v38.id !== '98' && this.data.v38.id !== '99') {
          if (typeof this.data.v38 !== 'undefined' && (parseInt(this.data.v38.id) < 1 || parseInt(this.data.v38.id) > 5)) {
            this.errors.push('La V38Clasificación de riesgo leucemias o linfomas y sólidos pediátricos Debe ser >=1 o <= 5 o,55,98,99')
            this.error = true
          }
        }

        if (typeof this.data.v38 !== 'undefined' && parseInt(this.data.v38.id) <= 5 && typeof this.data.v28 !== 'undefined' && this.data.v28.id !== '95') {
          this.errors.push('La V38 es <= 5 Entonces V28 DEBE SER = 95')
          this.error = true
        }

        if (typeof this.data.v38 !== 'undefined' && this.data.v38.id === '55' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 es 14 revisar La V38  Debe ser 55')
          this.error = true
        }

        if (typeof this.data.v38 !== 'undefined' && this.data.v38.id === '98' && (this.data.v17 !== 'C810' || this.data.v17 !== 'C811' || this.data.v17 !== 'C812' || this.data.v17 !== 'C813' || this.data.v17 !== 'C817' || this.data.v17 !== 'C819' || this.data.v17 !== 'C820' || this.data.v17 !== 'C821' || this.data.v17 !== 'C822' || this.data.v17 !== 'C827' || this.data.v17 !== 'C829')) {
          this.errors.push('La V38 es  98 revisar la V17')
          this.error = true
        }

        if (typeof this.data.v38 !== 'undefined' && this.data.v38.id === '98') {
        ...
        if (typeof this.data.v39 !== 'undefined' && Date.parse(this.data.v39) < Date.parse('1800-01-01') && typeof this.data.v39 !== 'undefined' && Date.parse(this.data.v39) > Date.parse('1845-01-01') && typeof this.data.v39 !== 'undefined' && Date.parse(this.data.v39) > Date.parse('1846-01-01')) {
          ...
          if (typeof this.data.v39 !== 'undefined' && typeof this.data.v134 !== 'undefined' && Date.parse(this.data.v39) > Date.parse(this.data.v134)) {
            this.errors.push('La V39 DEBE SER <= V134')
            this.error = true
          }
        }

        if (typeof this.data.v39 !== 'undefined' && Date.parse(this.data.v39) === Date.parse('1846-01-01') && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 es 14 revisar la V39 debe ser 1846-01-01')
          this.error = true
        }

        if (typeof this.data.v39 !== 'undefined' && Date.parse(this.data.v39) === Date.parse('1845-01-01') && typeof this.data.v38 !== 'undefined' && this.data.v38.id !== '98') {
          this.errors.push('La V39 es 1845-01-01 revisar la V38 debe ser 98')
          this.error = true
        }

        if (typeof this.data.v39 !== 'undefined' && Date.parse(this.data.v39) > Date.parse('1846-01-01') && typeof this.data.v20 !== 'undefined' && typeof this.data.v39 !== 'undefined' && Date.parse(this.data.v20) > Date.parse(this.data.v39)) {
          this.errors.push('La V39 es >1846-01-01 revisar la V20 debe ser <= V39')
          this.error = true
        }

        if (typeof this.data.v39 !== 'undefined' && Date.parse(this.data.v39) > Date.parse(('1846-01-01') && typeof this.data.v38 !== 'undefined' && parseInt(this.data.v38.id) > 13)) {
          this.errors.push('La V39 es >1846-01-01 revisar la V38 debe ser <= 13')
          this.error = true
        }
        if (typeof this.data.v40 !== 'undefined' && this.data.v40.id === '2') {
          if (typeof this.data.v48 !== 'undefined' && this.data.v48.id !== '98' && typeof this.data.v48 !== 'undefined' && this.data.v48.id !== '11' && typeof this.data.v48 !== 'undefined' && this.data.v48.id !== '12') {
            this.errors.push('La V48 es 98,11,12o 13 revisar la V40 debe ser 2')
            this.error = true
          }
        }

        if (typeof this.data.v40 !== 'undefined' && this.data.v40.id === '55' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 es 14 revisar la V40 debe ser 55')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '1' && typeof this.data.v126 !== 'undefined' && this.data.v126 !== '8') {
          this.errors.push('La V126  = 8  y V45, V74,V86,V106, V111,V114 son <> 1 revisar la V41 debe ser 1')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '1' && typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '1') {
          this.errors.push('La V45  es <> 1 revisar la V41 debe ser 1')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '1' && typeof this.data.v74 !== 'undefined' && this.data.v74.id !== '1') {
          this.errors.push('La V74  es <> 1 revisar la V41 debe ser 1')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '1' && typeof this.data.v86 !== 'undefined' && this.data.v86 !== '1') {
          this.errors.push('La V86  es <> 1 revisar la V41 debe ser 1')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '1' && typeof this.data.v106 !== 'undefined' && this.data.v106 === '1') {
          this.errors.push('La V106 es <> 1 revisar la V41 debe ser 1')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '1' && typeof this.data.v111 !== 'undefined' && this.data.v111 === '1') {
          this.errors.push('La V111 es <> 1 revisar la V41 debe ser 1')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '1' && typeof this.data.v114 !== 'undefined' && this.data.v114 === '1') {
          this.errors.push('La V114 es <> 1 revisar la V41 debe ser 1')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '2' && typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '1') {
          this.errors.push('La V45 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '2' && typeof this.data.v74 !== 'undefined' && this.data.v74.id !== '1') {
          this.errors.push('La V74 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '2' && typeof this.data.v86 !== 'undefined' && this.data.v86 !== '1') {
          this.errors.push('La V86 es = 1  revisar la V41 debe ser 2')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '2' && typeof this.data.v106 !== 'undefined' && this.data.v106 !== '1') {
          this.errors.push('La V106 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '2' && typeof this.data.v111 !== 'undefined' && this.data.v111 !== '1') {
          this.errors.push('La V111 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '2' && typeof this.data.v114 !== 'undefined' && this.data.v114 !== '1') {
          this.errors.push('La V114 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '4' && typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '1') {
          this.errors.push('La V45 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '4' && typeof this.data.v74 !== 'undefined' && this.data.v74.id !== '1') {
          this.errors.push('La V74 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '4' && typeof this.data.v86 !== 'undefined' && this.data.v86 !== '1') {
          this.errors.push('La V86 es = 1  revisar la V41 debe ser 2')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '4' && typeof this.data.v106 !== 'undefined' && this.data.v106 !== '1') {
          this.errors.push('La V106 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '4' && typeof this.data.v111 !== 'undefined' && this.data.v111 !== '1') {
          this.errors.push('La V111 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '4' && typeof this.data.v114 !== 'undefined' && this.data.v114 !== '1') {
          this.errors.push('La V114 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '5' && typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '1') {
          this.errors.push('La V45 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '5' && typeof this.data.v74 !== 'undefined' && this.data.v74.id !== '1') {
          this.errors.push('La V74 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '5' && typeof this.data.v86 !== 'undefined' && this.data.v86 !== '1') {
          this.errors.push('La V86 es = 1  revisar la V41 debe ser 2')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '5' && typeof this.data.v106 !== 'undefined' && this.data.v106 !== '1') {
          this.errors.push('La V106 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '5' && typeof this.data.v111 !== 'undefined' && this.data.v111 !== '1') {
          this.errors.push('La V111 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && typeof this.data.v41 !== 'undefined' && this.data.v114 === '5' && typeof this.data.v41 !== 'undefined' && this.data.v114 !== '1') {
          this.errors.push('La V114 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }
        // a
        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '6' && typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '1') {
          this.errors.push('La V45 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '6' && typeof this.data.v74 !== 'undefined' && this.data.v74.id !== '1') {
          this.errors.push('La V74 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '6' && typeof this.data.v86 !== 'undefined' && this.data.v86 !== '1') {
          this.errors.push('La V86 es = 1  revisar la V41 debe ser 2')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '6' && typeof this.data.v106 !== 'undefined' && this.data.v106 !== '1') {
          this.errors.push('La V106 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '6' && typeof this.data.v111 !== 'undefined' && this.data.v111 !== '1') {
          this.errors.push('La V111 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '6' && typeof this.data.v114 !== 'undefined' && this.data.v114 !== '1') {
          this.errors.push('La V114 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }
        //
        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '3' && typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '14') {
          this.errors.push('La V45 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '3' && typeof this.data.v74 !== 'undefined' && this.data.v74.id !== '2') {
          this.errors.push('La V74 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '3' && typeof this.data.v86 !== 'undefined' && this.data.v86 !== '98') {
          this.errors.push('La V86 es = 1  revisar la V41 debe ser 2')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '3' && typeof this.data.v06 !== 'undefined' && this.data.v106 !== '1') {
          this.errors.push('La V106 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '3' && typeof this.data.v111 !== 'undefined' && this.data.v111 !== '98') {
          this.errors.push('La V111 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '3' && typeof this.data.v114 !== 'undefined' && this.data.v114 !== '2') {
          this.errors.push('La V114 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }
        //
        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '99' && typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '1') {
          this.errors.push('La V45 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '99' && typeof this.data.v74 !== 'undefined' && this.data.v74.id !== '1') {
          this.errors.push('La V74 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '99' && typeof this.data.v86 !== 'undefined' && this.data.v86 !== '1') {
          this.errors.push('La V86 es = 1  revisar la V41 debe ser 2')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '99' && typeof this.data.v106 !== 'undefined' && this.data.v106 !== '1') {
          this.errors.push('La V106 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '99' && typeof this.data.v111 !== 'undefined' && this.data.v111 !== '1') {
          this.errors.push('La V111 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }

        if (typeof this.data.v41 !== 'undefined' && this.data.v41 === '99' && typeof this.data.v114 !== 'undefined' && this.data.v114 !== '1') {
          this.errors.push('La V114 es = 1  revisar la V41 debe ser 2,4,5 o 6')
          this.error = true
        }
        // 42
        if (typeof this.data.v42 !== 'undefined' && this.data.v42.id === '55' && typeof this.data.v43 !== 'undefined' && this.data.v43 !== '1846-01-01') {
          this.errors.push('La V43 es 1846-01-01 revisar la V42 deb ser 55')
          this.error = true
        }

        if (typeof this.data.v42 !== 'undefined' && this.data.v42.id === '55' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 es 14 revisar la V42 deb ser 55')
          this.error = true
        }

        if (typeof this.data.v42 !== 'undefined' && this.data.v42.id === '1' && typeof this.data.v44 !== 'undefined' && this.data.v44.id === '99') {
          this.errors.push('La V44 es <> 99 revisar la V42 debe ser 1')
          this.error = true
        }

        if (typeof this.data.v42 !== 'undefined' && this.data.v42.id === '1' && this.data.v43 !== '1845-01-01') {
          this.errors.push('La V43 es <> 1845-01-01 revisar la V42 debe ser 1')
          this.error = true
        }

        if (typeof this.data.v42 !== 'undefined' && this.data.v42.id === '2' && this.data.v43 !== '1845-01-01') {
          this.errors.push('La V43 es = 1845-01-01, revisar la V42 debe ser 2')
          this.error = true
        }

        if (typeof this.data.v42 !== 'undefined' && this.data.v42.id === '99' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '2') {
          this.errors.push('La V128 es <> 2 revisar la V42 debe ser 99')
          this.error = true
        }

        if (typeof this.data.v42 !== 'undefined' && this.data.v42.id === '99' && this.data.v43 !== '1800-01-01') {
          this.errors.push('La V43 es 1800-01-01 revisar la V42 debe ser 99')
          this.error = true
        }

        if (typeof this.data.v43 !== 'undefined' && this.data.v43 !== '1800-01-01' && typeof this.data.v43 !== 'undefined' && this.data.v43 !== '1845-01-01' && typeof this.data.v43 !== 'undefined' && this.data.v43 !== '1846-01-01') {
          if (Date.parse(this.data.v43) < Date.parse(this.patient.field_json.birthdate)) {
            this.errors.push('La V43 DEBE SER >= V18')
            this.error = true
          }

          if (typeof this.data.v43 !== 'undefined' && typeof this.data.v134 !== 'undefined' && Date.parse(this.data.v43) > Date.parse(this.data.v134)) {
            this.errors.push('La V43 DEBE SER <= V134')
            this.error = true
          }
        }

        if (typeof this.data.v43 !== 'undefined' && this.data.v43 === '1846-01-01' && typeof this.data.v128 !== 'undefined' && this.data.v128 !== '14') {
          this.errors.push('La V128 es 14 revisar la V43 debe ser 1846-01-01')
          this.error = true
        }

        if (typeof this.data.v43 !== 'undefined' && this.data.v43 === '1845-01-01' && typeof this.data.v42 !== 'undefined' && this.data.v42 !== '2') {
          this.errors.push('La V43 es 1845-01-01 revisar la V42 debe ser 2')
          this.error = true
        }

        // 44
        if (typeof this.data.v44 !== 'undefined' && this.data.v44.id === '55' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 es 14 revisar la V44 debe ser 55')
          this.error = true
        }
        // 45
        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '1' && typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '55' && typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '98') {
          this.errors.push('La V45 debe ser 1,55, o 98')
          this.error = true
        }

        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '1' && typeof this.data.v47 !== 'undefined' && parseInt(this.data.v47) > 55) {
          this.errors.push('La V47 es < 55 revisar la V45 debe ser = 1')
          this.error = true
        }

        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '1' && typeof this.data.v48 !== 'undefined' && parseInt(this.data.v48) > 13) {
          this.errors.push('La V48 es <= 13 revisar la V45 debe ser = 1')
          this.error = true
        }

        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '1' && typeof this.data.v49 !== 'undefined' && this.data.v49 < Date.parse('1846-01-01')) {
          this.errors.push('La V49 es >= 1846-01-01 revisar la V45 debe ser = 1')
          this.error = true
        }

        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '1' && typeof this.data.v50 !== 'undefined' && parseInt(this.data.v50) > 5) {
          this.errors.push('La V50 es <=5 revisar la V45 debe ser = 1')
          this.error = true
        }

        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '1' && this.data.v51 !== '98') {
          this.errors.push('La V51 es <>98 revisar la V45 debe ser = 1')
          this.error = true
        }

        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '1' && typeof this.data.v53_1 !== 'undefined' && parseInt(this.data.v53_1) < 98) {
          this.errors.push('La V53.1 es >98 revisar la V45 debe ser = 1')
          this.error = true
        }

        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '1') {
          if (typeof this.data.v57 !== 'undefined' && parseInt(this.data.v57.id) > 2) {
        ...
        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '1') {
          if (typeof this.data.v61 !== 'undefined' && parseInt(this.data.v61.id) > 97) {
            this.errors.push('La V61 es <= 97 revisar la V45 debe ser = 1')
            this.error = true
          }
        }
        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '55' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 es 14 revisar la V45 debe ser 55')
          this.error = true
        }

        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '98' && typeof this.data.v53_1 !== 'undefined' && this.data.v53_1.id !== '98') {
          this.errors.push('La V53.1 es 98, revisar la V45 debe ser 55')
          this.error = true
        }

        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '98' && typeof this.data.v66_1 !== 'undefined' && this.data.v66_1.id !== '98') {
          this.errors.push('La V66.1 es 98, revisar la V45 debe ser 55')
          this.error = true
        }

        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '98' && this.data.v47 !== '98') {
          this.errors.push('La V47 es 98, revisar la V45 debe ser 55')
          this.error = true
        }

        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '98' && typeof this.data.v48 !== 'undefined' && this.data.v48.id !== '98') {
          this.errors.push('La V48 es 98  revisar la V45 debe ser 55')
          this.error = true
        }

        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '98' && this.data.v49 !== '1845-01-01') {
          this.errors.push('La V49 es 1845-01-01  revisar la V45 debe ser 55')
          this.error = true
        }

        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '98' && this.data.v50 !== '98') {
          this.errors.push('La V50 es 98  revisar la V45 debe ser 55')
          this.error = true
        }

        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '98') {
          if (typeof this.data.v51 !== 'undefined' && this.data.v51 !== '98') {
            this.errors.push('La V51 es 98  revisar la V45 debe ser 55')
            this.error = true
          }
          if (typeof this.data.v53 !== 'undefined' && this.data.v52 !== '98') {
            this.errors.push('La V52 es 98  revisar la V45 debe ser 55')
            this.error = true
          }
          if (typeof this.data.v53 !== 'undefined' && this.data.v53 !== '98') {
        ...
        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '98') {
          if (typeof this.data.v57 !== 'undefined' && this.data.v57.id !== '98') {
            this.errors.push('La V57 debe ser 98. Revisar la V45 debe ser 55.')
            this.error = true
          }
          if (typeof this.data.v58 !== 'undefined' && this.data.v58 !== '1845-01-01') {
            this.errors.push('La V58 debe ser 1845-01-01. Revisar la V45 debe ser 55.')
            this.error = true
          }
          if (typeof this.data.v59 !== 'undefined' && this.data.v59.id !== '98') {
            this.errors.push('La V59 debe ser 98. Revisar la V45 debe ser 55.')
            this.error = true
          }
        }
        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '98' && typeof this.data.v60 !== 'undefined' && this.data.v60.id !== '98') {
          this.errors.push('La V60 es 98  revisar la V45 debe ser 55')
          this.error = true
        }

        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '98' && typeof this.data.v61 !== 'undefined' && this.data.v61.id !== '98') {
          this.errors.push('La V61  es 98  revisar la V45 debe ser 55')
          this.error = true
        }
        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '1' && typeof this.data.v59 !== 'undefined' && this.data.v59.id === '98') {
          this.errors.push('LA V59 es <> 98 revisar la V45 debe ser 1')
          this.error = true
        }
        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '98' && (typeof this.data.v46 !== 'undefined' && this.data.v46.id !== '0' && typeof this.data.v46 !== 'undefined' && this.data.v46.id !== '98')) {
          this.errors.push('La V46 es 0 o 98 revisar la V45 debe ser 98')
          this.error = true
        }
        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '98' && typeof this.data.v62 !== 'undefined' && this.data.v62 !== '1845-01-01') {
          this.errors.push('La V62 es 1845-01-01 revisar la V45 debe ser 98')
          this.error = true
        }

        if (typeof this.data.v45 !== 'undefined' && this.data.v45.id === '98' && typeof this.data.v63 !== 'undefined' && this.data.v63 !== '98') {
          this.errors.push('La V63 es 98 revisar la V45 debe ser 98')
          this.error = true
        }

        if (typeof this.data.v245 !== 'undefined' && this.data.v45.id === '98' && typeof this.data.v70 !== 'undefined' && this.data.v70.id !== '98') {
          this.errors.push('La V70 es 98 revisar la V45 debe ser 98')
          this.error = true
        }
        if (typeof this.data.v46 !== 'undefined' && this.data.v46.id === '98' && (this.data.v17 === 'C835' || this.data.v17 === 'C910' || this.data.v17 === 'C920' || this.data.v17 === 'C924' || this.data.v17 === 'C925')) {
          this.errors.push('La V46 es 98 revisar la V17 debe ser diferente  de C835 y <>C910 y <>920 y <>C924 y <> C925')
          this.error = true
        }
        if (typeof this.data.v46 !== 'undefined' && parseInt(this.data.v46) < 0) {
          this.errors.push('El valor de v46 debe ser mayor o igual a 0')
          this.error = true
        }
        if (typeof this.data.v46 !== 'undefined' && parseInt(this.data.v46) > 10) {
        ...
        if (typeof this.data.v46 !== 'undefined' && parseInt(this.data.v46) <= 10) {
          if (this.data.v17 !== 'C835' && this.data.v17 !== 'C910' && this.data.v17 !== 'C920' && this.data.v17 !== 'C924' && this.data.v17 !== 'C925') {
            this.errors.push('Cuando v46 sea <= 10 Entonces v17 DEBE SER = C835, C910, C920, C924 o C925')
            this.error = true
          }
        }
        if (typeof this.data.v46 !== 'undefined' && this.data.v46.id === '55' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 debe ser 14 revisar la V46 debe ser 55')
          this.error = true
        }
        if (typeof this.data.v46 !== 'undefined' && this.data.v46.id === '0') {
          if (typeof this.data.v46_1 !== 'undefined' && this.data.v46_1.id !== '97') {
            this.errors.push('La V46.1 es 97 revisar V46 debe ser 98')
            this.error = true
          }
          if (typeof this.data.v46_2 !== 'undefined' && this.data.v46_2.id !== '97') {
            this.errors.push('La V46.2 es 97 revisar V46 debe ser 99')
            this.error = true
          }
          if (typeof this.data.v46_3 !== 'undefined' && this.data.v46_3.id !== '97') {
            this.errors.push('La V46.3 es 97 revisar V46 debe ser 100')
            this.error = true
          }
          if (typeof this.data.v46_4 !== 'undefined' && this.data.v46_4.id !== '97') {
            this.errors.push('La V46.4 es 97 revisar V46 debe ser 101')
            this.error = true
          }
          if (typeof this.data.v46_5 !== 'undefined' && this.data.v46_5.id !== '97') {
            this.errors.push('La V46.5 es 97 revisar V46 debe ser 102')
            this.error = true
          }

          if (typeof this.data.v46_6 !== 'undefined' && this.data.v46_6.id !== '97') {
            this.errors.push('La V46.6 es 97 revisar V46 debe ser 103')
            this.error = true
          }

          if (typeof this.data.v46_7 !== 'undefined' && this.data.v46_7.id !== '97') {
            this.errors.push('La V46.7 es 97 revisar V46 debe ser 104')
            this.error = true
          }

          if (typeof this.data.v46_8 !== 'undefined' && this.data.v46_8.id !== '97') {
            this.errors.push('La V46.8 es 97 revisar V46 debe ser 105')
            this.error = true
          }
        }
        // g
        if (typeof this.data.v46 !== 'undefined' && this.data.v46.id === '98') {
          if (typeof this.data.v46_1 !== 'undefined' && this.data.v46_1.id !== '2') {
            this.errors.push('La V46.1 debe ser 2, revisar V46 debe ser 0')
            this.error = true
          }
          if (typeof this.data.v46_2 !== 'undefined' && this.data.v46_2.id !== '2') {
            this.errors.push('La V46.2 debe ser 2, revisar V46 debe ser 0')
            this.error = true
          }
          if (typeof this.data.v46_3 !== 'undefined' && this.data.v46_3.id !== '2') {
            this.errors.push('La V46.3 debe ser 2, revisar V46 debe ser 0')
            this.error = true
          }
          if (typeof this.data.v46_4 !== 'undefined' && this.data.v46_4.id !== '2') {
            this.errors.push('La V46.4 debe ser 2, revisar V46 debe ser 0')
            this.error = true
          }
          if (typeof this.data.v46_5 !== 'undefined' && this.data.v46_5.id !== '2') {
            this.errors.push('La V46.5 es 2 revisar V46 debe ser 0')
            this.error = true
          }

          if (typeof this.data.v46_6 !== 'undefined' && this.data.v46_6.id !== '2') {
            this.errors.push('La V46.6 es 2 revisar V46 debe ser 0')
            this.error = true
          }

          if (typeof this.data.v46_7 !== 'undefined' && this.data.v46_7.id !== '2') {
            this.errors.push('La V46.7 es 2 revisar V46 debe ser 0')
            this.error = true
          }

          if (typeof this.data.v46_8 !== 'undefined' && this.data.v46_8.id !== '2') {
        ...
        // 46.1
        if (typeof this.data.v46_1 !== 'undefined' && this.data.v46_1.id === '55' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 debe ser 14, revisa la V46.1 debe ser 55')
          this.error = true
        }
        if (typeof this.data.v46_1 !== 'undefined' && this.data.v46_1.id === '1') {
          if (typeof this.data.v46 !== 'undefined' && this.data.v46.id === '98' && typeof this.data.v46 !== 'undefined' && this.data.v46.id === '0') {
        ...
        // 46.2
        if (typeof this.data.v46_2 !== 'undefined' && this.data.v46_2.id === '55' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 debe ser 14, revisa la V46.2 debe ser 55')
          this.error = true
        }
        if (typeof this.data.v46_2 !== 'undefined' && this.data.v46_2.id === '1') {
          if (typeof this.data.v46 !== 'undefined' && this.data.v46.id === '98' && typeof this.data.v46 !== 'undefined' && this.data.v46.id === '0') {
        ...
        // 46.3
        if (typeof this.data.v46_3 !== 'undefined' && this.data.v46_3.id === '55' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 debe ser 14, revisa la V46.3 debe ser 55')
          this.error = true
        }
        if (typeof this.data.v46_3 !== 'undefined' && this.data.v46_3.id === '1') {
        ...
        // 46.4
        if (typeof this.data.v46_4 !== 'undefined' && this.data.v46_4.id === '55' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 debe ser 14, revisa la V46.4 debe ser 55')
          this.error = true
        }
        if (typeof this.data.v46_4 !== 'undefined' && this.data.v46_4.id === '1') {
          if (typeof this.data.v46 !== 'undefined' && this.data.v46.id === '98' && typeof this.data.v46 !== 'undefined' && this.data.v46.id === '0') {
        ...
        // 46.5
        if (typeof this.data.v46_5 !== 'undefined' && this.data.v46_5.id === '55' && typeof this.data.v4128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 debe ser 14, revisa la V46.5 debe ser 55')
          this.error = true
        }
        if (typeof this.data.v46_5 !== 'undefined' && this.data.v46_5.id === '1') {
          if (typeof this.data.v46 !== 'undefined' && this.data.v46.id === '98' && typeof this.data.v46 !== 'undefined' && this.data.v46.id === '0') {
        ...
        // 46.6
        if (typeof this.data.v46_6 !== 'undefined' && this.data.v46_6.id === '55' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 debe ser 14, revisa la V46.6 debe ser 55')
          this.error = true
        }
        if (typeof this.data.v46_6 !== 'undefined' && this.data.v46_6.id === '1') {
          if (typeof this.data.v46 !== 'undefined' && this.data.v46.id === '98' && typeof this.data.v46 !== 'undefined' && this.data.v46.id === '0') {
        ...
        // 46.7
        if (typeof this.data.v46_7 !== 'undefined' && this.data.v46_7.id === '55' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 debe ser 14, revisa la V46.7 debe ser 55')
          this.error = true
        }
        if (typeof this.data.v46_7 !== 'undefined' && this.data.v46_7.id === '1') {
          if (typeof this.data.v46 !== 'undefined' && this.data.v46.id === '98' && typeof this.data.v46 !== 'undefined' && this.data.v46.id === '0') {
        ...
        // 46.8
        if (typeof this.data.v46_8 !== 'undefined' && this.data.v46_8.id === '55' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 debe ser 14, revisa la V46.8 debe ser 55')
          this.error = true
        }
        if (typeof this.data.v46_8 !== 'undefined' && this.data.v46_8.id === '1') {
          if (typeof this.data.v46 !== 'undefined' && this.data.v46.id === '98' && typeof this.data.v46 !== 'undefined' && this.data.v46.id === '0') {
        ...
        // 47
        if (typeof this.data.v47 !== 'undefined' && this.data.v47 !== '98' && typeof this.data.v47 !== 'undefined' && this.data.v47 !== '55') {
          if (typeof this.data.v47 !== 'undefined' && parseInt(this.data.v47) < 1 && typeof this.data.v47 !== 'undefined' && parseInt(this.data.v47) > 50) {
            this.errors.push('La V47 debe ser estar entre 1 y 50 o = 55 o 98')
            this.error = true
          }
        }
        if (typeof this.data.v47 !== 'undefined' && this.data.v47 === '55' && typeof this.data.v128 !== 'undefined' && this.data.v128 !== '14') {
          this.errors.push('La V128 es 14  revisar la V47 debe ser 55')
          this.error = true
        }

        if (typeof this.data.v47 !== 'undefined' && this.data.v47 === '98' && typeof this.data.v45 !== 'undefined' && this.data.v45 !== '98') {
          this.errors.push('La V47 es 98 revisar la V45 debe ser 98')
          this.error = true
        }

        if (typeof this.data.v47 !== 'undefined' && parseInt(this.data.v47) < 55 && typeof this.data.v45 !== 'undefined' && this.data.v45 !== '1') {
          this.errors.push('La V47 es < 55 revisar la V45 debe ser = 1')
          this.error = true
        }
        if (typeof this.data.v48 !== 'undefined' && this.data.v48.id === '55' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 es 14 revisar la V48 debe ser 55')
          this.error = true
        }
        if (typeof this.data.v48 !== 'undefined' && this.data.v48.id !== '1' && typeof this.data.v48 !== 'undefined' && this.data.v48.id !== '2' && typeof this.data.v48 !== 'undefined' && this.data.v48.id !== '3' && typeof this.data.v48 !== 'undefined' && this.data.v48.id !== '11' && typeof this.data.v48 !== 'undefined' && this.data.v48.id !== '12' && typeof this.data.v48 !== 'undefined' && this.data.v48.id !== '55' && typeof this.data.v48 !== 'undefined' && this.data.v48.id !== '98' && typeof this.data.v48 !== 'undefined' && this.data.v48.id !== '13') {
          this.errors.push('La V48  debe ser 1,2,3,11,12,55,98 0 13')
          this.error = true
        }

        if (typeof this.data.v48 !== 'undefined' && parseInt(this.data.v48.id) <= 13 && this.data.v45.id !== '1') {
          this.errors.push('La V48 es <= 13 revisar la V45 debe ser 1')
          this.error = true
        }
        if (typeof this.data.v48 !== 'undefined' && this.data.v48.id === '98' && typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '98') {
          this.errors.push('La V48 es = 98 revisar la V45 debe ser 98')
          this.error = true
        }

        if (typeof this.data.v49 !== 'undefined' && this.data.v49 !== '1845-01-01' && typeof this.data.v49 !== 'undefined' && this.data.v49 !== '1846-01-01') {
          if (typeof this.data.v49 !== 'undefined' && typeof this.data.v18 !== 'undefined' && this.data.v49 < this.data.v18) {
            this.errors.push('v49 DEBE SER >= V18 Fecha de diagnóstico del cáncer reportado actualmente')
            this.error = true
          }
          if (typeof this.data.v49 !== 'undefined' && typeof this.data.v134 !== 'undefined' && this.data.v49 > this.data.v134) {
            this.errors.push('v49 DEBE SER <= V134')
            this.error = true
          }
        }
        if (typeof this.data.v49 !== 'undefined' && typeof this.data.v128 !== 'undefined' && this.data.v49 === '1846-01-01' && this.data.v128 !== '14') {
          this.errors.push('La V128 debe ser 14, revisar la V49 debe ser 1846-01-01')
          this.error = true
        }

        if (typeof this.data.v49 !== 'undefined' && typeof this.data.v45 !== 'undefined' && this.data.v49 === '1845-01-01' && this.data.v45 !== '98') {
          this.errors.push('La V45 debe ser 98, revisar la V49 debe ser 1845-01-01')
          this.error = true
        }
        if (typeof this.data.v49 !== 'undefined' && Date.parse(this.data.v49) > '1846-01-01' && typeof this.data.v49 !== 'undefined' && typeof this.data.v18 !== 'undefined' && parseInt(this.data.v49) < this.data.v18) {
          this.errors.push('La v49 es 1846-01-01  revisar la V49 debe ser >= V18')
          this.error = true
        }

        if (typeof this.data.v49 !== 'undefined' && typeof this.data.v45 !== 'undefined' && Date.parse(this.data.v49) > '1846-01-01' && this.data.v45 !== '1') {
          this.errors.push('La v49 es 1846-01-01  revisar la V45 debe ser 1')
          this.error = true
        }
        // 50
        if (typeof this.data.v50 !== 'undefined' && typeof this.data.v52 !== 'undefined' && parseInt(this.data.v50) >= 2 && this.data.v52 === '98') {
          this.errors.push('La V52 es <>98 revisar la V50 debe ser >= 2 y  <98')
          this.error = true
        }
        if (typeof this.data.v50 !== 'undefined' && typeof this.data.v52 !== 'undefined' && parseInt(this.data.v50) < 98 && this.data.v52 === '98') {
          this.errors.push('La V52 es <>98 revisar la V50 debe ser >= 2 y  <98')
          this.error = true
        }

        if (typeof this.data.v50 !== 'undefined' && typeof this.data.v50 !== 'undefined' && this.data.v50 !== '55' && this.data.v50 !== '98') {
          if (parseInt(this.data.v50) < 1 || parseInt(this.data.v50) > 5) {
            this.errors.push('La V50 debe estar entre 1 y 5 o = 55 o 98')
            this.error = true
          }
        }
        if (typeof this.data.v50 !== 'undefined' && typeof this.data.v128 !== 'undefined' && this.data.v50 === '55' && this.data.v128 !== '14') {
          this.errors.push('La V128 debe ser 14, revisar la V50 debe ser 55')
          this.error = true
        }
        if (typeof this.data.v50 !== 'undefined' && this.data.v50 === '1' && typeof this.data.v51 !== 'undefined' && this.data.v51.id === '98') {
          this.errors.push('La V51 <>98 revisar la V50 debe ser 1')
          this.error = true
        }

        if (typeof this.data.v50 !== 'undefined' && this.data.v50 === '1' && typeof this.data.v52 !== 'undefined' && this.data.v52.id !== '98') {
          this.errors.push('La V52 es 98 revisar la V50 debe ser 1')
          this.error = true
        }

        if (typeof this.data.v50 !== 'undefined' && this.data.v50 === '98') {
          if (typeof this.data.v45 !== 'undefined' && this.data.v45 !== '98' && this.data.v45 !== '2') {
        ...
        if (typeof this.data.v50 !== 'undefined' && this.data.v50 === '98') {
          if (typeof this.data.v52 !== 'undefined' && this.data.v52 !== '98') {
        ...
        if (typeof this.data.v50 !== 'undefined' && parseInt(this.data.v50) <= 5) {
          if (typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '1') {
        ...
        if (typeof this.data.v51 !== 'undefined' && this.data.v51 === '55') {
          if (typeof this.data.v128 !== 'undefined' && this.data.v128 !== '14') {
        ...
        if (typeof this.data.v51 !== 'undefined' && this.data.v51 === '98') {
          if (typeof this.data.v45 !== 'undefined' && this.data.v45 !== '98') {
            this.errors.push('La V51 es 98 revisar la V45 debe ser 98')
            this.error = true
          }
        }

        if (typeof this.data.v51 !== 'undefined' && parseInt(this.data.v51) > 98) {
          if (typeof this.data.v45 !== 'undefined' && this.data.v45 !== '1') {
            this.errors.push('La V51 es >98 revisar la V45 debe ser 1')
            this.error = true
          }
        }
        // 52
        if (typeof this.data.v52 !== 'undefined' && this.data.v52 === '55') {
          if (typeof this.data.v128 !== 'undefined' && this.data.v128 !== '14') {
        ...
        // 53
        if (typeof this.data.v53 !== 'undefined' && this.data.v53 !== '98' && this.data.v53 !== '99') {
          if (parseInt(this.data.v53) < 1 || parseInt(this.data.v53) > 12) {
            this.errors.push('La V53 debe estar entre 1 y 12  o 98 0 99')
            this.error = true
          }
        }
        if (this.data.v53 === '99' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 debe ser 14, revisar la V53 debe ser 99')
          this.error = true
        }
        if (typeof this.data.v53 !== 'undefined' && typeof this.data.v45 !== 'undefined' && this.data.v53 === '98' && this.data.v45 !== '98') {
          this.errors.push('La V51 es 98 revisar V45 debe ser 98')
          this.error = true
        }

        if (this.data.v53 === '98' && typeof this.data.v53_1 !== 'undefined' && this.data.v53_1.id !== '98') {
          this.errors.push('La V53.1 es 98  revisar la V53 debe ser 98')
          this.error = true
        }

        if (typeof this.data.v53 !== 'undefined' && this.data.v53 === '98' && typeof this.data.v53_2 !== 'undefined' && this.data.v53_2.id !== '98') {
          this.errors.push('La V53.2 es 98  revisar la V53 debe ser 99')
          this.error = true
        }

        if (typeof this.data.v53 !== 'undefined' && this.data.v53 === '98' && typeof this.data.v53_3 !== 'undefined' && this.data.v53_3.id !== '98') {
          this.errors.push('La V53.3 es 98  revisar la V53 debe ser 100')
          this.error = true
        }

        if (typeof this.data.v53 !== 'undefined' && this.data.v53 === '98' && typeof this.data.v53_4 !== 'undefined' && this.data.v53_4.id !== '98') {
          this.errors.push('La V53.4 es 98  revisar la V53 debe ser 100')
          this.error = true
        }

        if (typeof this.data.v53 !== 'undefined' && this.data.v53 === '98' && typeof this.data.v53_5 !== 'undefined' && this.data.v53_5.id !== '98') {
          this.errors.push('La V53.5 es 98  revisar la V53 debe ser 100')
          this.error = true
        }

        if (typeof this.data.v53 !== 'undefined' && this.data.v53 === '98' && typeof this.data.v53_6 !== 'undefined' && this.data.v53_6.id !== '98') {
          this.errors.push('La V53.6 es 98  revisar la V53 debe ser 100')
          this.error = true
        }

        if (typeof this.data.v53 !== 'undefined' && this.data.v53 === '98' && typeof this.data.v53_7 !== 'undefined' && this.data.v53_7.id !== '98') {
          this.errors.push('La V53.7 es 98  revisar la V53 debe ser 100')
          this.error = true
        }
        if (this.data.v53 === '98' && typeof this.data.v53_8 !== 'undefined' && this.data.v53_8.id !== '98') {
          this.errors.push('La V53.8 es 98  revisar la V53 debe ser 100')
          this.error = true
        }
        if (this.data.v53 === '98' && typeof this.data.v53_9 !== 'undefined' && this.data.v53_9.id !== '98') {
          this.errors.push('La V53.9 es 98  revisar la V53 debe ser 100')
          this.error = true
        }
        if (typeof this.data.v53 !== 'undefined' && typeof this.data.v54 !== 'undefined' && this.data.v53 === '98' && this.data.v54 !== '98') {
          this.errors.push('La V54 es 98 revisar la V53 debe ser 98')
          this.error = true
        }
        if (typeof this.data.v53 !== 'undefined' && typeof this.data.v56 !== 'undefined' && this.data.v53 === '98' && this.data.v56 !== '98') {
          this.errors.push('La V56 es 98 revisar la V53 debe ser 98')
          this.error = true
        }
        if (typeof this.data.v53 !== 'undefined' && typeof this.data.v55 !== 'undefined' && this.data.v53 === '98' && this.data.v55 !== '98') {
          this.errors.push('La V55 es 98 revisar la V53 debe ser 98')
          this.error = true
        }

        if (typeof this.data.v53 !== 'undefined' && this.data.v53 === '98') {
          if (typeof this.data.v47 !== 'undefined' && this.data.v47 !== '98') {
            this.errors.push('La V53 es 98 revisar la V47 debe ser 98')
            this.error = true
          }
          if (typeof this.data.v49 !== 'undefined' && this.data.v49 !== '1845-01-01') {
        ...
        if (typeof this.data.v53 !== 'undefined' && parseInt(this.data.v53) <= 12) {
          if (typeof this.data.v47 !== 'undefined' && this.data.v47 !== '98') {
          ...
          if (typeof this.data.v98 !== 'undefined' && this.data.v45 !== '98') {
            this.errors.push('La V53 es <= 12 revisar la V50 debe ser <> 98')
            this.error = true
          }
          if (typeof this.data.v53_1 !== 'undefined' && this.data.v53_1.id !== '98') {
            this.errors.push('La V53 es <= 12 revisar la V50 debe ser <> 98')
            this.error = true
          }
        }
        // 53.1
        if (typeof this.data.v53_1 !== 'undefined' && this.data.v53_1.id === '98' && typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '98') {
          this.errors.push('La V53.1 es 98  revisar la V45 debe ser  98')
          this.error = true
        }

        if (typeof this.data.v53_1 !== 'undefined' && parseInt(this.data.v53_1.id) > 98 && this.data.v45.id !== '1') {
          this.errors.push('La V53.1 es > 98  revisar la V45 debe ser  1')
          this.error = true
        }

        if (typeof this.data.v53_1 !== 'undefined' && this.data.v53_1.id === '55' && typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '55') {
          this.errors.push('La V53.1 es > 98  revisar la V45 debe ser  1')
          this.error = true
        }
        if (typeof this.data.v53_1 !== 'undefined' && parseInt(this.data.v53_1.id) > 98) {
          if (typeof this.data.v53_2 !== 'undefined' && this.data.v53_1 !== 'undefined' && this.data.v53_2.id === this.data.v53_1.id) {
            this.errors.push('La V53.2 es <> V53.1 revisar V53.1  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_3 !== 'undefined' && this.data.v53_1 !== 'undefined' && this.data.v53_3.id === this.data.v53_1.id) {
            this.errors.push('La V53.3 es <> V53.1 revisar V53.1  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_4 !== 'undefined' && this.data.v53_1 !== 'undefined' && this.data.v53_4.id === this.data.v53_1.id) {
            this.errors.push('La V53.4 es <> V53.1 revisar V53.1  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_5 !== 'undefined' && this.data.v53_1 !== 'undefined' && this.data.v53_5.id === this.data.v53_1.id) {
            this.errors.push('La V53.5 es <> V53.1 revisar V53.1  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_6 !== 'undefined' && this.data.v53_1 !== 'undefined' && this.data.v53_6.id === this.data.v53_1.id) {
            this.errors.push('La V53.6 es <> V53.1 revisar V53.1  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_7 !== 'undefined' && this.data.v53_1 !== 'undefined' && this.data.v53_7.id === this.data.v53_1.id) {
            this.errors.push('La V53.7 es <> V53.1 revisar V53.1  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_8 !== 'undefined' && this.data.v53_1 !== 'undefined' && this.data.v53_8.id === this.data.v53_1.id) {
            this.errors.push('La V53.8 es <> V53.1 revisar V53.1  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_9 !== 'undefined' && this.data.v53_1 !== 'undefined' && this.data.v53_9.id === this.data.v53_1.id) {
            this.errors.push('La V53.9 es <> V53.1 revisar V53.1  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v54 !== 'undefined' && this.data.v53_1 !== 'undefined' && this.data.v54.id === this.data.v53_1.id) {
            this.errors.push('La V54 es <> V53.1 revisar la V53.1 debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v55 !== 'undefined' && this.data.v53_1 !== 'undefined' && this.data.v55.id === this.data.v53_1.id) {
            this.errors.push('La V55 es <> V53.1 revisar la V53.1 debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v56 !== 'undefined' && this.data.v53_1 !== 'undefined' && this.data.v56.id === this.data.v53_1.id) {
            this.errors.push('La V56 es <> V53.1 revisar la V53.1 debe ser > 98')
            this.error = true
          }
        }
        if (typeof this.data.v53_1 !== 'undefined' && this.data.v53_1.id !== '55' && parseInt(this.data.v53_1.id) < 98) {
          this.errors.push('La V53.1 deber ser 55 o >= 98')
          this.error = true
        }

        // 52.2
        if (typeof this.data.v53_2 !== 'undefined' && this.data.v53_2.id === '98' && typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '98') {
          this.errors.push('La V53.2 es 98  revisar la V45 debe ser  98')
          this.error = true
        }
        if (typeof this.data.v53_2 !== 'undefined' && this.data.v53_2.id > '98' && typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '1') {
          this.errors.push('La V53.2 es > 98  revisar la V45 debe ser  1')
          this.error = true
        }
        if (typeof this.data.v53_2 !== 'undefined' && typeof this.data.v45 !== 'undefined' && this.data.v53_2.id === '55' && this.data.v45.id !== '55') {
          this.errors.push('La V53.2 es > 98  revisar la V45 debe ser  1')
          this.error = true
        }
        if (typeof this.data.v53_2 !== 'undefined' && parseInt(this.data.v53_2.id) > 98 && typeof this.data.v53_1 !== 'undefined' && parseInt(this.data.v53_1.id) <= 98) {
          this.errors.push('La v53.2 es > 98 revisar la v53.1 debe ser > 98')
          this.error = true
        }

        if (typeof this.data.v53_3 !== 'undefined' && parseInt(this.data.v53_3.id) > 98) {
          if (typeof this.data.v53_2 !== 'undefined' && this.data.v53_3 !== 'undefined' && this.data.v53_2.id === this.data.v53_3.id) {
            this.errors.push('La V53.2 es <> V53.3 revisar V53.2  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_3 !== 'undefined' && this.data.v53_2 !== 'undefined' && this.data.v53_3.id === this.data.v53_2.id) {
            this.errors.push('La V53.3 es <> V53.2 revisar V53.2  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_4 !== 'undefined' && this.data.v53_2 !== 'undefined' && this.data.v53_4.id === this.data.v53_2.id) {
            this.errors.push('La V53.4 es <> V53.2 revisar V53.2  debe ser > 98')
            this.error = true
          }

          if (typeof this.data.v53_5 !== 'undefined' && this.data.v53_2 !== 'undefined' && this.data.v53_5.id === this.data.v53_2.id) {
            this.errors.push('La V53.5 es <> V53.2 revisar V53.2  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_6 !== 'undefined' && this.data.v53_2 !== 'undefined' && this.data.v53_6.id === this.data.v53_2.id) {
            this.errors.push('La V53.6 es <> V53.2 revisar V53.2  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_7 !== 'undefined' && this.data.v53_2 !== 'undefined' && this.data.v53_7.id === this.data.v53_2.id) {
            this.errors.push('La V53.7 es <> V53.2 revisar V53.2  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_8 !== 'undefined' && this.data.v53_2 !== 'undefined' && this.data.v53_8.id === this.data.v53_2.id) {
            this.errors.push('La V53.8 es <> V53.2 revisar V53.2  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_9 !== 'undefined' && this.data.v53_2 !== 'undefined' && this.data.v53_9.id === this.data.v53_2.id) {
            this.errors.push('La V53.9 es <> V53.2 revisar V53.2  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v554 !== 'undefined' && this.data.v53_2 !== 'undefined' && this.data.v54.id === this.data.v53_2.id) {
            this.errors.push('La V54 es <> V53.2 revisar la V53.2 debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v55 !== 'undefined' && this.data.v53_2 !== 'undefined' && this.data.v55.id === this.data.v53_2.id) {
            this.errors.push('La V55 es <> V53.2 revisar la V53.2 debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v56 !== 'undefined' && this.data.v53_2 !== 'undefined' && this.data.v56.id === this.data.v53_2.id) {
            this.errors.push('La V56 es <> V53.2 revisar la V53.2 debe ser > 98')
            this.error = true
          }
        }

        if (typeof this.data.v53_2 !== 'undefined' && this.data.v53_2.id === '97' && typeof this.data.v53_3 !== 'undefined' && this.data.v53_3.id !== '97') {
          this.errors.push('La V53.3 debe ser 97')
          this.error = true
        }
        // 53
        if (typeof this.data.v53_3 !== 'undefined' && this.data.v53_3.id === '98' && typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '98') {
          this.errors.push('La V53.2 es 98  revisar la V45 debe ser  98')
          this.error = true
        }
        if (typeof this.data.v53_3 !== 'undefined' && parseInt(this.data.v53_3.id) > '98' && this.data.v45.id !== '1') {
          this.errors.push('La V53.2 es > 98  revisar la V45 debe ser  1')
          this.error = true
        }
        if (typeof this.data.v53_3 !== 'undefined' && this.data.v53_3.id === '55' && typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '55') {
          this.errors.push('La V53.2 es > 98  revisar la V45 debe ser  1')
          this.error = true
        }
        if (typeof this.data.v53_3 !== 'undefined' && parseInt(this.data.v53_3.id) > 98 && typeof this.data.v53_1 !== 'undefined' && parseInt(this.data.v53_1.id) <= 98) {
          this.errors.push('La v53.2 es > 98 revisar la v53.1 debe ser > 98')
          this.error = true
        }

        if (typeof this.data.v53_3 !== 'undefined' && parseInt(this.data.v53_3.id) > 98) {
          if (typeof this.data.v53_4 !== 'undefined' && this.data.v53_3 !== 'undefined' && this.data.v53_4.id === this.data.v53_3.id) {
            this.errors.push('La V53.4 es <> V53.2 revisar V53.2  debe ser > 98')
            this.error = true
          }

          if (typeof this.data.v53_5 !== 'undefined' && this.data.v53_3 !== 'undefined' && this.data.v53_5.id === this.data.v53_3.id) {
            this.errors.push('La V53.5 es <> V53.2 revisar V53.2  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_6 !== 'undefined' && this.data.v53_3 !== 'undefined' && this.data.v53_6.id === this.data.v53_3.id) {
            this.errors.push('La V53.6 es <> V53.2 revisar V53.2  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_7 !== 'undefined' && this.data.v53_3 !== 'undefined' && this.data.v53_7.id === this.data.v53_3.id) {
            this.errors.push('La V53.7 es <> V53.2 revisar V53.2  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_8 !== 'undefined' && this.data.v53_3 !== 'undefined' && this.data.v53_8.id === this.data.v53_3.id) {
            this.errors.push('La V53.8 es <> V53.2 revisar V53.2  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_9 !== 'undefined' && this.data.v53_3 !== 'undefined' && this.data.v53_9.id === this.data.v53_3.id) {
            this.errors.push('La V53.9 es <> V53.2 revisar V53.2  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v54 !== 'undefined' && this.data.v53_3 !== 'undefined' && this.data.v54.id === this.data.v53_3.id) {
            this.errors.push('La V54 es <> V53.2 revisar la V53.2 debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v55 !== 'undefined' && this.data.v53_3 !== 'undefined' && this.data.v55.id === this.data.v53_3.id) {
            this.errors.push('La V55 es <> V53.2 revisar la V53.2 debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v56 !== 'undefined' && this.data.v53_3 !== 'undefined' && this.data.v56.id === this.data.v53_3.id) {
            this.errors.push('La V56 es <> V53.2 revisar la V53.2 debe ser > 98')
            this.error = true
          }
        }

        if (typeof this.data.v53_3 !== 'undefined' && this.data.v53_3.id === '97' && typeof this.data.v53_4 !== 'undefined' && this.data.v53_4.id !== '97') {
          this.errors.push('La V53.4 debe ser 97')
          this.error = true
        }

        // 53.4
        if (typeof this.data.v53_4 !== 'undefined' && typeof this.data.v45 !== 'undefined' && this.data.v53_4.id === '98' && this.data.v45.id !== '98') {
          this.errors.push('La V53.2 es 98  revisar la V45 debe ser  98')
          this.error = true
        }
        if (typeof this.data.v53_4 !== 'undefined' && typeof this.data.v45 !== 'undefined' && parseInt(this.data.v53_4.id) > 98 && this.data.v45.id !== '1') {
          this.errors.push('La V53.2 es > 98  revisar la V45 debe ser  1')
          this.error = true
        }
        if (typeof this.data.v53_4 !== 'undefined' && typeof this.data.v45 !== 'undefined' && this.data.v53_4.id === '55' && this.data.v45.id !== '55') {
          this.errors.push('La V53.4 es > 98  revisar la V45 debe ser  1')
          this.error = true
        }
        if (typeof this.data.v53_4 !== 'undefined' && parseInt(this.data.v53_4.id) > 98 && parseInt(this.data.v53_1.id) <= 98) {
          this.errors.push('La v53.4 es > 98 revisar la v53.1 debe ser > 98')
          this.error = true
        }

        if (typeof this.data.v53_4 !== 'undefined' && parseInt(this.data.v53_4.id) > 98) {
          if (typeof this.data.v53_5 !== 'undefined' && typeof this.data.v53_4 !== 'undefined' && this.data.v53_5.id === this.data.v53_4.id) {
            this.errors.push('La V53.5 es <> V53.4 revisar V53.4  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_6 !== 'undefined' && typeof this.data.v53_4 !== 'undefined' && this.data.v53_6.id === this.data.v53_4.id) {
            this.errors.push('La V53.6 es <> V53.4 revisar V53.4  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_7 !== 'undefined' && typeof this.data.v53_4 !== 'undefined' && this.data.v53_7.id === this.data.v53_4.id) {
            this.errors.push('La V53.7 es <> V53.4 revisar V53.4  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_8 !== 'undefined' && typeof this.data.v53_4 !== 'undefined' && this.data.v53_8.id === this.data.v53_4.id) {
            this.errors.push('La V53.8 es <> V53.4 revisar V53.4  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_9 !== 'undefined' && typeof this.data.v53_4 !== 'undefined' && this.data.v53_9.id === this.data.v53_4.id) {
            this.errors.push('La V53.9 es <> V53.4 revisar V53.4  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v54 !== 'undefined' && typeof this.data.v53_4 !== 'undefined' && this.data.v54.id === this.data.v53_4.id) {
            this.errors.push('La V54 es <> V53.4 revisar la V53.4 debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v55 !== 'undefined' && typeof this.data.v53_4 !== 'undefined' && this.data.v55.id === this.data.v53_4.id) {
            this.errors.push('La V55 es <> V53.4 revisar la V53.4 debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v56 !== 'undefined' && typeof this.data.v53_4 !== 'undefined' && this.data.v56.id === this.data.v53_4.id) {
            this.errors.push('La V56 es <> V53.4 revisar la V53.4 debe ser > 98')
            this.error = true
          }
        }

        if (typeof this.data.v53_5 !== 'undefined' && typeof this.data.v53_4 !== 'undefined' && this.data.v53_4.id === '97' && this.data.v53_5.id !== '97') {
          this.errors.push('La V53.5 debe ser 97')
          this.error = true
        }

        // 53.4
        if (typeof this.data.v45 !== 'undefined' && typeof this.data.v53_4 !== 'undefined' && this.data.v53_4.id === '98' && this.data.v45.id !== '98') {
          this.errors.push('La V53.2 es 98  revisar la V45 debe ser  98')
          this.error = true
        }
        if (typeof this.data.v45 !== 'undefined' && typeof this.data.v53_4 !== 'undefined' && this.data.v53_4.id > '98' && this.data.v45.id !== '1') {
          this.errors.push('La V53.2 es > 98  revisar la V45 debe ser  1')
          this.error = true
        }
        if (typeof this.data.v45 !== 'undefined' && typeof this.data.v53_4 !== 'undefined' && this.data.v53_4.id === '55' && this.data.v45.id !== '55') {
          this.errors.push('La V53.4 es > 98  revisar la V45 debe ser  1')
          this.error = true
        }
        if (typeof this.data.v53_1 !== 'undefined' && typeof this.data.v53_4 !== 'undefined' && parseInt(this.data.v53_4.id) > 98 && parseInt(this.data.v53_1.id) <= 98) {
          this.errors.push('La v53.4 es > 98 revisar la v53.1 debe ser > 98')
          this.error = true
        }
        ...
        // 53.5
        if (typeof this.data.v53_5 !== 'undefined' && typeof this.data.v45 !== 'undefined' && this.data.v53_5.id === '98' && this.data.v45.id !== '98') {
          this.errors.push('La V53.2 es 98  revisar la V45 debe ser  98')
          this.error = true
        }
        if (typeof this.data.v53_5 !== 'undefined' && typeof this.data.v45 !== 'undefined' && this.data.v53_5.id > '98' && this.data.v45.id !== '1') {
          this.errors.push('La V53.2 es > 98  revisar la V45 debe ser  1')
          this.error = true
        }
        if (typeof this.data.v53_5 !== 'undefined' && typeof this.data.v45 !== 'undefined' && this.data.v53_5.id === '55' && this.data.v45.id !== '55') {
          this.errors.push('La V53.5 es > 98  revisar la V45 debe ser  1')
          this.error = true
        }
        if (typeof this.data.v53_5 !== 'undefined' && typeof this.data.v53_1 !== 'undefined' && parseInt(this.data.v53_5.id) > 98 && parseInt(this.data.v53_1.id) <= 98) {
          this.errors.push('La v53.5 es > 98 revisar la v53.1 debe ser > 98')
          this.error = true
        }

        if (typeof this.data.v53_5 !== 'undefined' && parseInt(this.data.v53_5.id) > 98) {
          if (typeof this.data.v53_5 !== 'undefined' && typeof this.data.v53_6 !== 'undefined' && this.data.v53_6.id === this.data.v53_5.id) {
            this.errors.push('La V53.6 es <> V53.5 revisar V53.5  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_5 !== 'undefined' && typeof this.data.v53_7 !== 'undefined' && this.data.v53_7.id === this.data.v53_5.id) {
            this.errors.push('La V53.7 es <> V53.5 revisar V53.5  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_5 !== 'undefined' && typeof this.data.v53_8 !== 'undefined' && this.data.v53_8.id === this.data.v53_5.id) {
            this.errors.push('La V53.8 es <> V53.5 revisar V53.5  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_5 !== 'undefined' && typeof this.data.v53_9 !== 'undefined' && this.data.v53_9.id === this.data.v53_5.id) {
            this.errors.push('La V53.9 es <> V53.5 revisar V53.5  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_5 !== 'undefined' && typeof this.data.v54 !== 'undefined' && this.data.v54.id === this.data.v53_5.id) {
            this.errors.push('La V54 es <> V53.5 revisar la V53.5 debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_5 !== 'undefined' && typeof this.data.v55 !== 'undefined' && this.data.v55.id === this.data.v53_5.id) {
            this.errors.push('La V55 es <> V53.5 revisar la V53.5 debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_5 !== 'undefined' && typeof this.data.v56 !== 'undefined' && this.data.v56.id === this.data.v53_5.id) {
            this.errors.push('La V56 es <> V53.5 revisar la V53.5 debe ser > 98')
            this.error = true
          }
        }

        if (typeof this.data.v53_5 !== 'undefined' && typeof this.data.v53_6 !== 'undefined' && this.data.v53_5.id === '97' && this.data.v53_6.id !== '97') {
          this.errors.push('La V53.5 debe ser 97')
          this.error = true
        }

        // 53.6
        if (typeof this.data.v45 !== 'undefined' && typeof this.data.v53_6 !== 'undefined' && this.data.v53_6.id === '98' && this.data.v45.id !== '98') {
          this.errors.push('La V53.2 es 98  revisar la V45 debe ser  98')
          this.error = true
        }
        if (typeof this.data.v45 !== 'undefined' && typeof this.data.v53_6 !== 'undefined' && this.data.v53_6.id > '98' && this.data.v45.id !== '1') {
          this.errors.push('La V53.2 es > 98  revisar la V45 debe ser  1')
          this.error = true
        }
        if (typeof this.data.v45 !== 'undefined' && typeof this.data.v53_6 !== 'undefined' && this.data.v53_6.id === '55' && this.data.v45.id !== '55') {
          this.errors.push('La V53.6 es > 98  revisar la V45 debe ser  1')
          this.error = true
        }
        if (typeof this.data.v53_1 !== 'undefined' && typeof this.data.v53_6 !== 'undefined' && parseInt(this.data.v53_6.id) > 98 && parseInt(this.data.v53_1.id) <= 98) {
          this.errors.push('La v53.5 es > 98 revisar la v53.1 debe ser > 98')
          this.error = true
        }

        if (typeof this.data.v53_6 !== 'undefined' && parseInt(this.data.v53_6.id) > 98) {
          if (typeof this.data.v53_7 !== 'undefined' && typeof this.data.v53_6 !== 'undefined' && this.data.v53_7.id === this.data.v53_6.id) {
            this.errors.push('La V53.7 es <> V53.6 revisar V53.6  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_8 !== 'undefined' && typeof this.data.v53_6 !== 'undefined' && this.data.v53_8.id === this.data.v53_6.id) {
            this.errors.push('La V53.8 es <> V53.6 revisar V53.6  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_9 !== 'undefined' && typeof this.data.v53_6 !== 'undefined' && this.data.v53_9.id === this.data.v53_6.id) {
            this.errors.push('La V53.9 es <> V53.6 revisar V53.6  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v54 !== 'undefined' && typeof this.data.v53_6 !== 'undefined' && this.data.v54.id === this.data.v53_6.id) {
            this.errors.push('La V54 es <> V53.6 revisar la V53.6 debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v55 !== 'undefined' && typeof this.data.v53_6 !== 'undefined' && this.data.v55.id === this.data.v53_6.id) {
            this.errors.push('La V55 es <> V53.6 revisar la V53.6 debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v56 !== 'undefined' && typeof this.data.v53_6 !== 'undefined' && this.data.v56.id === this.data.v53_6.id) {
            this.errors.push('La V56 es <> V53.6 revisar la V53.6 debe ser > 98')
            this.error = true
          }
        }

        if (typeof this.data.v53_5 !== 'undefined' && typeof this.data.v53_6 !== 'undefined' && this.data.v53_5.id === '97' && this.data.v53_6.id !== '97') {
          this.errors.push('La V53.6 debe ser 97')
          this.error = true
        }

        // 53.7
        if (typeof this.data.v45 !== 'undefined' && typeof this.data.v53_7 !== 'undefined' && this.data.v53_7.id === '98' && this.data.v45.id !== '98') {
          this.errors.push('La V53.7 es 98  revisar la V45 debe ser  98')
          this.error = true
        }
        if (typeof this.data.v45 !== 'undefined' && typeof this.data.v53_7 !== 'undefined' && this.data.v53_7.id > '98' && this.data.v45.id !== '1') {
          this.errors.push('La V53.7 es > 98  revisar la V45 debe ser  1')
          this.error = true
        }
        if (typeof this.data.v45 !== 'undefined' && typeof this.data.v53_7 !== 'undefined' && this.data.v53_7.id === '55' && this.data.v45.id !== '55') {
          this.errors.push('La V53.7 es > 98  revisar la V45 debe ser  1')
          this.error = true
        }
        if (typeof this.data.v53_1 !== 'undefined' && typeof this.data.v53_7 !== 'undefined' && parseInt(this.data.v53_7.id) > 98 && parseInt(this.data.v53_1.id) <= 98) {
          this.errors.push('La v53.5 es > 98 revisar la v53.1 debe ser > 98')
          this.error = true
        }

        if (typeof this.data.v53_7 !== 'undefined' && parseInt(this.data.v53_7.id) > 98) {
          if (typeof this.data.v53_8 !== 'undefined' && typeof this.data.v53_7 !== 'undefined' && this.data.v53_8.id === this.data.v53_7.id) {
            this.errors.push('La V53.8 es <> V53.7 revisar V53.7  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v53_9 !== 'undefined' && typeof this.data.v53_7 !== 'undefined' && this.data.v53_9.id === this.data.v53_7.id) {
            this.errors.push('La V53.9 es <> V53.7 revisar V53.7  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v54 !== 'undefined' && typeof this.data.v53_7 !== 'undefined' && this.data.v54.id === this.data.v53_7.id) {
            this.errors.push('La V54 es <> V53.7 revisar la V53.7 debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v55 !== 'undefined' && typeof this.data.v53_7 !== 'undefined' && this.data.v55.id === this.data.v53_7.id) {
            this.errors.push('La V55 es <> V53.7 revisar la V53.7 debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v56 !== 'undefined' && typeof this.data.v53_7 !== 'undefined' && this.data.v56.id === this.data.v53_7.id) {
            this.errors.push('La V56 es <> V53.7 revisar la V53.7 debe ser > 98')
            this.error = true
          }
        }

        if (typeof this.data.v53_6 !== 'undefined' && typeof this.data.v53_7 !== 'undefined' && this.data.v53_6.id === '97' && this.data.v53_7.id !== '97') {
          this.errors.push('La V53.7 debe ser 97')
          this.error = true
        }

        // 53.8
        if (typeof this.data.v45 !== 'undefined' && typeof this.data.v53_8 !== 'undefined' && this.data.v53_8.id === '98' && this.data.v45.id !== '98') {
          this.errors.push('La V53.8 es 98  revisar la V45 debe ser  98')
          this.error = true
        }
        if (typeof this.data.v45 !== 'undefined' && typeof this.data.v53_8 !== 'undefined' && this.data.v53_8.id > '98' && this.data.v45.id !== '1') {
          this.errors.push('La V53.8 es > 98  revisar la V45 debe ser  1')
          this.error = true
        }
        if (typeof this.data.v45 !== 'undefined' && typeof this.data.v53_8 !== 'undefined' && this.data.v53_8.id === '55' && this.data.v45.id !== '55') {
          this.errors.push('La V53.8 es > 98  revisar la V45 debe ser  1')
          this.error = true
        }
        if (typeof this.data.v53_1 !== 'undefined' && typeof this.data.v53_8 !== 'undefined' && parseInt(this.data.v53_8.id) > 98 && parseInt(this.data.v53_1.id) <= 98) {
          this.errors.push('La v53.5 es > 98 revisar la v53.1 debe ser > 98')
          this.error = true
        }

        if (typeof this.data.v53_8 !== 'undefined' && parseInt(this.data.v53_8.id) > 98) {
          if (typeof this.data.v53_9 !== 'undefined' && typeof this.data.v53_8 !== 'undefined' && this.data.v53_9.id === this.data.v53_8.id) {
            this.errors.push('La V53.9 es <> V53.8 revisar V53.8  debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v54 !== 'undefined' && typeof this.data.v53_8 !== 'undefined' && this.data.v54.id === this.data.v53_8.id) {
            this.errors.push('La V54 es <> V53.8 revisar la V53.8 debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v55 !== 'undefined' && typeof this.data.v53_8 !== 'undefined' && this.data.v55.id === this.data.v53_8.id) {
            this.errors.push('La V55 es <> V53.8 revisar la V53.8 debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v56 !== 'undefined' && typeof this.data.v53_8 !== 'undefined' && this.data.v56.id === this.data.v53_8.id) {
            this.errors.push('La V56 es <> V53.8 revisar la V53.8 debe ser > 98')
            this.error = true
          }
        }

        if (typeof this.data.v53_7 !== 'undefined' && typeof this.data.v53_8 !== 'undefined' && this.data.v53_7.id === '97' && this.data.v53_8.id !== '97') {
          this.errors.push('La V53.8 debe ser 97')
          this.error = true
        }

        // 53.9
        if (typeof this.data.v45 !== 'undefined' && typeof this.data.v53_9 !== 'undefined' && this.data.v53_9.id === '98' && this.data.v45.id !== '98') {
          this.errors.push('La V53.8 es 98  revisar la V45 debe ser  98')
          this.error = true
        }
        if (typeof this.data.v45 !== 'undefined' && typeof this.data.v53_9 !== 'undefined' && this.data.v53_9.id > '98' && this.data.v45.id !== '1') {
          this.errors.push('La V53.8 es > 98  revisar la V45 debe ser  1')
          this.error = true
        }
        if (typeof this.data.v45 !== 'undefined' && typeof this.data.v53_9 !== 'undefined' && this.data.v53_9.id === '55' && this.data.v45.id !== '55') {
          this.errors.push('La V53.8 es > 98  revisar la V45 debe ser  1')
          this.error = true
        }
        if (typeof this.data.v53_1 !== 'undefined' && typeof this.data.v53_9 !== 'undefined' && parseInt(this.data.v53_9.id) > 98 && parseInt(this.data.v53_1.id) <= 98) {
          this.errors.push('La v53.5 es > 98 revisar la v53.1 debe ser > 98')
          this.error = true
        }

        if (typeof this.data.v53_9 !== 'undefined' && parseInt(this.data.v53_9.id) > 98) {
          if (typeof this.data.v54 !== 'undefined' && typeof this.data.v53_9 !== 'undefined' && this.data.v54.id === this.data.v53_9.id) {
            this.errors.push('La V54 es <> V53.8 revisar la V53.8 debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v55 !== 'undefined' && typeof this.data.v53_9 !== 'undefined' && this.data.v55.id === this.data.v53_9.id) {
            this.errors.push('La V55 es <> V53.8 revisar la V53.8 debe ser > 98')
            this.error = true
          }
          if (typeof this.data.v56 !== 'undefined' && typeof this.data.v53_9 !== 'undefined' && this.data.v56.id === this.data.v53_9.id) {
            this.errors.push('La V56 es <> V53.8 revisar la V53.8 debe ser > 98')
            this.error = true
          }
        }

        if (typeof this.data.v53_8 !== 'undefined' && typeof this.data.v53_9 !== 'undefined' && this.data.v53_8.id === '97' && this.data.v53_9.id !== '97') {
          this.errors.push('La V53.9 debe ser 97')
          this.error = true
        }

        // 54
        if (typeof this.data.v45 !== 'undefined' && typeof this.data.v54 !== 'undefined' && this.data.v54.id === '97' && this.data.v45.id !== '1') {
          this.errors.push('La V54 es 97  revisar la V45 debe ser 1')
          this.error = true
        }

        if (typeof this.data.v45 !== 'undefined' && typeof this.data.v54 !== 'undefined' && this.data.v54.id === '98' && this.data.v45.id !== '98') {
          this.errors.push('La V54 es =  98  revisar la V45 debe ser 98')
          this.error = true
        }

        if (typeof this.data.v45 !== 'undefined' && typeof this.data.v54 !== 'undefined' && parseInt(this.data.v54.id) > 98 && this.data.v45.id !== '1') {
          this.errors.push('La V54 es > 98 revisar la V45 debe ser 1')
          this.error = true
        }

        if (typeof this.data.v53_9 !== 'undefined' && typeof this.data.v54 !== 'undefined' && parseInt(this.data.v54.id) > 98 && parseInt(this.data.v53_9) < 98) {
          this.errors.push('La V54 es >98 revisar V53.9 debe ser >98')
          this.error = true
        }

        if (typeof this.data.v55 !== 'undefined' && typeof this.data.v54 !== 'undefined' && parseInt(this.data.v54.id) > 98 && this.data.v55 !== this.data.v54) {
          this.errors.push('La V55 es <> V54 revisar la V54 debe ser > 98')
          this.error = true
        }

        if (typeof this.data.v56 !== 'undefined' && typeof this.data.v54 !== 'undefined' && parseInt(this.data.v54.id) > 98 && this.data.v56 !== this.data.v54) {
          this.errors.push('La V56 es <> V54 revisar la V54 debe ser > 98')
          this.error = true
        }
        if (typeof this.data.v54 !== 'undefined' && this.data.v54.id === '97') {
          if (typeof this.data.v55 !== 'undefined' && this.data.v55.id !== '97') {
            this.errors.push('La V55 es 97 revisar V54 deber ser 97')
            this.error = true
          }
        }
        // 55
        if (typeof this.data.v55 !== 'undefined' && this.data.v55.id === '97') {
          if (typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '1') {
            this.errors.push('La V55 es 97  revisar la V45 debe ser 1')
            this.error = true
          }
        }
        if (typeof this.data.v55 !== 'undefined' && this.data.v55.id === '98') {
          if (typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '98') {
            this.errors.push('La V55 es =  98  revisar la V45 debe ser 98')
            this.error = true
          }
        }
        if (typeof this.data.v55 !== 'undefined' && typeof this.data.v45 !== 'undefined' && parseInt(this.data.v55.id) > 98 && this.data.v45.id !== '1') {
          this.errors.push('La V55 es > 98  revisar la V53.8 debe ser  1')
          this.error = true
        }

        if (typeof this.data.v55 !== 'undefined' && parseInt(this.data.v55.id) > 98 && parseInt(this.data.v54.id) <= 98) {
          this.errors.push('La V55 es >98 revisar V54 debe ser >98')
          this.error = true
        }

        if (typeof this.data.v55 !== 'undefined' && this.data.v55.id === '55') {
          if (typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '55') {
            this.errors.push('La V55 es 55 revisar la V45 debe ser 55')
            this.error = true
          }
        }

        if (typeof this.data.v55 !== 'undefined' && this.data.v55.id === '97') {
          if (typeof this.data.v56 !== 'undefined' && this.data.v56.id !== '97') {
            this.errors.push('La V56 es 97 revisar la V55 debe ser 97')
            this.error = true
          }
        }

        if (typeof this.data.v55 !== 'undefined' && this.data.v55.id > '98') {
          if (typeof this.data.v56 !== 'undefined' && this.data.v56.id === this.data.v55.id) {
            this.errors.push('La V55 <> V56 revisar la V55 debe ser >98')
            this.error = true
          }
        }
        // 56

        if (typeof this.data.v56 !== 'undefined' && typeof this.data.v45 !== 'undefined' && this.data.v56.id === '97' && this.data.v45.id !== '1') {
          this.errors.push('La V56 es 97 revisar la V45 debe ser 1')
          this.error = true
        }
        if (typeof this.data.v56 !== 'undefined' && typeof this.data.v45 !== 'undefined' && this.data.v56.id === '98' && this.data.v45.id !== '98') {
          this.errors.push('La V56 es 98 revisar la V45 debe ser 98')
          this.error = true
        }
        if (typeof this.data.v56 !== 'undefined' && parseInt(this.data.v56.id) > 98) {
          if (typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '1') {
            this.errors.push('La V56 es > 98 revisar la V53.8 debe ser 1')
            this.error = true
          }
        }
        if (typeof this.data.v56 !== 'undefined' && parseInt(this.data.v56.id) > 98) {
          if (typeof this.data.v55 !== 'undefined' && parseInt(this.data.v55.id) <= 98) {
            this.errors.push('La V55 es >98 revisar V55 debe ser >98')
            this.error = true
          }
        }
        if (typeof this.data.v56 !== 'undefined' && this.data.v56.id === '55') {
          if (typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '55') {
            this.errors.push('La V56 es 55 revisar la V45 debe ser 55')
            this.error = true
          }
        }

        // 57
        if (typeof this.data.v45 !== 'undefined' && typeof this.data.v57 !== 'undefined' && this.data.v57.id === '1' && this.data.v45.id !== '1') {
          this.errors.push('La V57 es 1 revisar la V45 debe ser 1')
          this.error = true
        }
        // 58
        if (typeof this.data.v58 !== 'undefined' && this.data.v58 !== '1800-01-01' && typeof this.data.v58 !== 'undefined' && this.data.v58 !== '1845-01-01' && typeof this.data.v58 !== 'undefined' && this.data.v58 !== '1846-01-01') {
          if (typeof this.data.v58 !== 'undefined' && typeof this.data.v49 !== 'undefined' && Date.parse(this.data.v58) < Date.parse(this.data.v49)) {
            this.errors.push('V58 DEBE SER >= V49')
            this.error = true
          }

          if (typeof this.data.v58 !== 'undefined' && typeof this.data.v134 !== 'undefined' && Date.parse(this.data.v58) > Date.parse(this.data.v134)) {
            this.errors.push('V58 DEBE SER <= V134')
            this.error = true
          }

          if (typeof this.data.v58 !== 'undefined' && (Date.parse(this.data.v58) < Date.parse('2021-01-02') || this.data.v58 === '1846-01-01')) {
            this.errors.push('La V58 debe ser >= 2021-01-02 o = 1846-01-01')
            this.error = true
          }
        }
        if (typeof this.data.v58 !== 'undefined' && this.data.v58 === '1846-01-01' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 = 14 revisar la V58 debe ser 1846-01-01')
          this.error = true
        }

        if (typeof this.data.v58 !== 'undefined' && this.data.v58 === '1800-01-01') {
          if (typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '1') {
            this.errors.push('La V58 es = 1800-01-01 revisar la V45 debe ser 1')
            this.error = true
          }
          if (typeof this.data.v59 !== 'undefined' && this.data.v59.id !== '3') {
            this.errors.push('La V59 es 3 revisar La V58 debe ser 1800-01-01')
            this.error = true
          }
          if (typeof this.data.v60 !== 'undefined' && this.data.v60.id !== '98') {
            this.errors.push('La V60 es = 98 revisar La V58 Debe ser  1800-01-01')
            this.error = true
          }
          if (typeof this.data.v61 !== 'undefined' && parseInt(this.data.v61.id) > 97) {
            this.errors.push('La V61 es 98revisar La V58 debe ser 1800-01-01')
            this.error = true
          }
        }
        if (typeof this.data.v58 !== 'undefined' && Date.parse(this.data.v58) > Date.parse('1846-01-01')) {
          if (typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '1') {
            this.errors.push('La V58 es > 1846-01-01 revisar la V45 debe ser 1')
            this.error = true
          }
          if (typeof this.data.v59 !== 'undefined' && parseInt(this.data.v59.id) > 2) {
            this.errors.push('la V59 es <2 revisar La V58 debe ser > 1846-01-01')
            this.error = true
          }
          if (typeof this.data.v61 !== 'undefined' && this.data.v61.id === '98') {
            this.errors.push('la V61 es <> 98 revisar La V58 debe ser > 1846-01-01')
            this.error = true
          }
        }
        if (typeof this.data.v58 !== 'undefined' && this.data.v58 === '1845-01-01') {
          if (typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '98' && this.data.v45.id !== '2') {
            this.errors.push('La V55 es 1845-01-01 revisar V45 debe ser = 98 o 2')
            this.error = true
          }
        }

        if (typeof this.data.v58 !== 'undefined' && this.data.v58 === '1800-01-01') {
          if (typeof this.data.v125 !== 'undefined' && this.data.v125.id !== '2' && this.data.v125.id !== '4' && this.data.v125.id !== '6' && this.data.v125.id !== '98' && this.data.v125.id !== '10') {
            this.errors.push('Cuando V58 sea = 1800-01-01 Entonces V125 DEBE SER = 2, 4, 6, 98 o 10')
            this.error = true
          }
        }
        if (typeof this.data.v58 !== 'undefined' && typeof this.data.v49 !== 'undefined' && Date.parse(this.data.v58) < Date.parse('1846-01-01') && Date.parse(this.data.v49) >= Date.parse(this.data.v58)) {
          this.errors.push('La V58 es 1846-01-01 revisar la V49 debe ser <= V58')
          this.error = true
        }
        // v59
        if (typeof this.data.v59 !== 'undefined' && typeof this.data.v60 !== 'undefined' && this.data.v59.id === '2' && parseInt(this.data.v60.id) > 8) {
          this.errors.push('La V60 es <= 8 revisar la V59 debe ser 2')
          this.error = true
        }

        if (typeof this.data.v59 !== 'undefined' && this.data.v59.id === '2' && Date.parse(this.data.v58) < Date.parse('1846-01-01')) {
          this.errors.push('La V50 es 2 revisar la V58 debe ser >1846-01-01')
          this.error = true
        }

        if (typeof this.data.v59 !== 'undefined' && typeof this.data.v45 !== 'undefined' && this.data.v59.id === '3' && this.data.v45 !== '1') {
          this.errors.push('La V59 es 3 revisar la V45 debe ser 1')
          this.error = true
        }
        if (typeof this.data.v59 !== 'undefined' && this.data.v59.id === '3' && this.data.v58 !== '1800-01-01') {
          this.errors.push('La V59 es 3 revisar La V58 debe ser 1800-01-01')
          this.error = true
        }
        if (typeof this.data.v59 !== 'undefined' && typeof this.data.v61 !== 'undefined' && this.data.v59.id === '3' && parseInt(this.data.v61.id) > 97) {
          this.errors.push('La V61 es <= 97 revisalr la v59 debe ser 3')
          this.error = true
        }
        if (typeof this.data.v59 !== 'undefined' && this.data.v59.id === '3' && typeof this.data.v60 !== 'undefined' && this.data.v60.id !== '98') {
          this.errors.push('La v60 es 98 revisar la V59 debe ser 3')
          this.error = true
        }
        if (typeof this.data.v59 !== 'undefined' && this.data.v59.id === '55' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 debe ser 14, revisar la V59 debe ser 55')
          this.error = true
        }
        if (typeof this.data.v59 !== 'undefined' && this.data.v59.id !== '98' && this.data.v59.id !== '55') {
          if (parseInt(this.data.v59.id) < 1) {
            this.errors.push('La V59 debe estar entre 1 y 3 o  = 98 0 55')
            this.error = true
          }

          if (typeof this.data.v59 !== 'undefined' && parseInt(this.data.v59.id) > 3) {
            this.errors.push('La V59 debe estar entre 1 y 3 o  = 98 0 55')
            this.error = true
          }
        }
        if (typeof this.data.v59 !== 'undefined' && this.data.v59.id === '1') {
          if (typeof this.data.v60 !== 'undefined' && this.data.v60.id !== '98') {
            this.errors.push('La V60 es 98 revisar la V59 debe ser 1')
            this.error = true
          }
          if (typeof this.data.v58 !== 'undefined' && Date.parse(this.data.v58) < Date.parse('2021-01-02')) {
            this.errors.push('La V59 es 1 revisar la V58 debe ser  >= 2021.01.02')
            this.error = true
          }
        }
        if (typeof this.data.v59 !== 'undefined' && this.data.v59.id === '98') {
          if (typeof this.data.v45 !== 'undefined' && this.data.v45.id !== '98' && this.data.v45.id !== '2') {
            this.errors.push('La V59 es 98 revisar la V45 debe ser 98 o 2')
            this.error = true
          }
        }
        // 60
        if (typeof this.data.v60 !== 'undefined' && this.data.v60.id !== '98' && this.data.v60.id !== '55') {
          if (this.data.v60.id < 1 || this.data.v60.id > 8) {
            this.errors.push('La V60 debe estar entre 1 y 8 o = 98 o 55')
            this.error = true
          }
        }
        if (typeof this.data.v60 !== 'undefined' && typeof this.data.v128 !== 'undefined' && this.data.v60.id === '55' && this.data.v128.id !== '14') {
          this.errors.push('LA V128 = 14 revisar la V60 debe ser 55')
          this.error = true
        }
        if (typeof this.data.v60 !== 'undefined' && this.data.v60.id === '3') {
          if (typeof this.data.v127 !== 'undefined' && this.data.v127.id !== '2') {
            this.errors.push('La V127 es 2 revisar la V60 debe ser 3')
            this.error = true
          }
          if (this.data.v131 !== '1845-01-01') {
            this.errors.push('La V131 es <> 1845-01-01 revisar la V60 debe ser 3')
            this.error = true
          }
          if (typeof this.data.v132 !== 'undefined' && this.data.v132.id !== '98') {
            this.errors.push('La V132 es <> 98 revisar la V60 debe ser 3')
            this.error = true
          }
        }
        if (typeof this.data.v60 !== 'undefined' && typeof this.data.v128 !== 'undefined' && this.data.v60.id === '3' && this.data.v128.id !== '10') {
          this.errors.push('Cuando V60 sea = 3 Entonces V128 DEBE SER = 10')
          this.error = true
        }

        if (typeof this.data.v60 !== 'undefined' && typeof this.data.v128 !== 'undefined' && this.data.v60.id === '3' && this.data.v128.id !== '4') {
          this.errors.push('Cuando V60 sea = 3 Entonces V128 DEBE SER = 4')
          this.error = true
        }
        if (typeof this.data.v60 !== 'undefined' && typeof this.data.v59 !== 'undefined' && parseInt(this.data.v60) <= 8 && this.data.v59 !== '2') {
          this.errors.push('La V60 <= 8 revisar la V50 debe ser 2')
          this.error = true
        }
        // 61

        // acá inicia la 80
        if (typeof this.data.v80 !== 'undefined' && this.data.v80 !== '1845-01-01' && this.data.v80 !== '1846-01-01') {
          if (typeof this.data.v80 !== 'undefined' && typeof this.data.v134 !== 'undefined' && (Date.parse(this.data.v80) < Date.parse('2021-01-02') || Date.parse(this.data.v80) > Date.parse(this.data.v134))) {
            this.errors.push('La V80 es = 1845 -01-01 o >= 2021-01-02  Y <= V134 o = 1846-01-01')
            this.error = true
          }
        }

        if (typeof this.data.v80 !== 'undefined' && Date.parse(this.data.v80) >= Date.parse('2021-01-02') && parseInt(this.data.v81) > -6) {
          this.errors.push('La V81 es <=  6 revisar la V80 debe ser >= 2021-01-02')
          this.error = true
        }

        // validacion 2
        if (typeof this.data.v80 !== 'undefined' && typeof this.data.v82 !== 'undefined' && Date.parse(this.data.v80) >= Date.parse('2021-01-02') && this.data.v82 === '98') {
          this.errors.push('La V82es <> 98 revisar la V80 debe ser >= 2021-01-02')
          this.error = true
        }

        // validacion 3
        if (typeof this.data.v80 !== 'undefined' && typeof this.data.v83 !== 'undefined' && Date.parse(this.data.v80) >= Date.parse('2021-01-02') && this.data.v83 === '98') {
          this.errors.push('La V83  es <> 98 revisar la V80 debe ser >= 2021-01-02')
          this.error = true
        }

        if (typeof this.data.v80 !== 'undefined' && typeof this.data.v84 !== 'undefined' && Date.parse(this.data.v80) >= Date.parse('2021-01-02') && parseInt(this.data.v84) > -6) {
          this.errors.push('La V84 es <= 6 revisar la V80 debe ser >= 2021-01-02')
          this.error = true
        }

        if (typeof this.data.v80 !== 'undefined' && this.data.v80 === '1846-01-01' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 debe ser = 14. Revisar la V80 debe ser 1846-01-01.')
          this.error = true
        }

        if (typeof this.data.v80 !== 'undefined' && this.data.v80 === '1845-01-01') {
          if (typeof this.data.v81 !== 'undefined' && this.data.v81.id !== '98') {
            this.errors.push('La V81 debe ser 98 revisar la V80 debe ser 1845-01-01')
            this.error = true
          }
          if (typeof this.data.v28 !== 'undefined' && this.data.v82.id !== '98') {
            this.errors.push('La V82 debe ser 98 revisar la V80 debe ser 1845-01-01')
            this.error = true
          }
          if (typeof this.data.v83 !== 'undefined' && this.data.v83.id !== '98') {
            this.errors.push('La V83 debe ser 98 revisar la V80 debe ser 1845-01-01')
            this.error = true
          }
          if (typeof this.data.v84 !== 'undefined' && this.data.v84.id !== '98') {
            this.errors.push('La V84 es 98 revisar la V80 debe ser 1845-01-01')
            this.error = true
          }
        }

        // en caso de que V80 sea >= 2021-01-02
        if (typeof this.data.v80 !== 'undefined' && Date.parse(this.data.v80) >= Date.parse('2021-01-02')) {
          if (parseInt(this.data.v75) <= -1) {
            this.errors.push('La V80 es > 2021-01-02 revisar la V75 debe ser -1')
            this.error = true
          }

          if (typeof this.data.v76 !== 'undefined' && typeof this.data.v80 !== 'undefined' && Date.parse(this.data.v76) >= Date.parse(this.data.v80)) {
            this.errors.push('La V80 es >2021-01-02 revisar la V76 debe ser < V80')
            this.error = true
          }
        }

        if (typeof this.data.v81 !== 'undefined' && this.data.v81.id !== '98' && this.data.v80 === '1845-01-01') {
          this.errors.push('La V81 es <> 98 revisar la V80 debe ser <> 1845-01-01')
          this.error = true
        }
        ...
        if (typeof this.data.v82 !== 'undefined' && this.data.v82 !== '98' && typeof this.data.v81 !== 'undefined' && this.data.v81.id === '98') {
          this.errors.push('La V82 es <> 98 revisar la V81 debe ser <> 98')
          this.error = true
        }

        if (typeof this.data.v82 !== 'undefined' && typeof this.data.v80 !== 'undefined' && this.data.v82 === '98' && this.data.v80 !== '1845-01-01') {
          this.errors.push('La V82 es 98 revisar la V80 debe ser 1845-01-01')
          this.error = true
        }

        if (typeof this.data.v83 !== 'undefined' && this.data.v83 !== '98' && typeof this.data.v81 !== 'undefined' && this.data.v81.id === '98') {
          this.errors.push('La V83 es <> 98 revisar la V81 debe ser <> 98')
          this.error = true
        }

        if (typeof this.data.v83 !== 'undefined' && typeof this.data.v80 !== 'undefined' && this.data.v83 === '98' && this.data.v80 !== '1845-01-01') {
          this.errors.push('La V83 es 98 revisar la V80 debe ser 1845-01-01')
          this.error = true
        }

        if (typeof this.data.v84 !== 'undefined' && this.data.v84.id !== '1' && this.data.v84.id !== '5' && this.data.v84.id !== '6' && this.data.v84.id !== '98' && this.data.v84.id !== '55') {
          this.errors.push('La V84 debe ser 1,5,6,98 o 55')
          this.error = true
        }

        if (typeof this.data.v84 !== 'undefined' && this.data.v84 !== '98' && typeof this.data.v81 !== 'undefined' && this.data.v81.id === '98') {
          this.errors.push('La V84 es <> 98 revisar la v81 debe ser <> 98')
          this.error = true
        }

        if (typeof this.data.v85 !== 'undefined' && this.data.v85.id === '1' && typeof this.data.v74 !== 'undefined' && this.data.v74.id !== '1') {
          this.errors.push('La V85 es 1 revisar la V74 debe ser 1')
          this.error = true
        }

        // Para la segunda validación
        if (typeof this.data.v85 !== 'undefined' && this.data.v85.id === '55' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 es = 14 revisar la V85 debe ser 55')
          this.error = true
        }

        // Para la tercera validación
        if (typeof this.data.v85 !== 'undefined' && this.data.v85.id === '98' && typeof this.data.v74 !== 'undefined' && this.data.v74.id === '1') {
          this.errors.push('La V85 es 98 revisar la V74 debe ser <> 1')
          this.error = true
        }

        // Cuando V85 sea = 2 Entonces V127 DEBE SER = 2 El mensaje de error es La V127 es 2 reviar la V85 debe ser 2
        if (typeof this.data.v85 !== 'undefined' && this.data.v85.id === '2' && typeof this.data.v127 !== 'undefined' && this.data.v127.id !== '2') {
          this.errors.push('La V127 es 2 reviar la V85 debe ser 2')
          this.error = true
        }

        // Cuando V85 sea = 2 Entonces V131 DEBE SER <> 1845-01-01 El mensaje de error es La V131 es <> 1845-01-01 reviar la V85 debe ser 2
        if (typeof this.data.v85 !== 'undefined' && this.data.v85.id === '2' && this.data.v131 === '1845-01-01') {
          this.errors.push('La V131 es <> 1845-01-01 reviar la V85 debe ser 2')
          this.error = true
        }

        // Cuando V85 sea = 2 Entonces V132 DEBE SER <> 98 El mensaje de error es La V132 es <> 98 revisar la V85 debe ser 2
        if (typeof this.data.v85 !== 'undefined' && this.data.v85.id === '2' && typeof this.data.v132 !== 'undefined' && this.data.v132.id === '98') {
          this.errors.push('La V132 es <> 98 revisar la V85 debe ser 2')
          this.error = true
        }

        // Cuando V85 sea = 2 Entonces V74 DEBE SER = 1 El mensaje de error es la V85 es 2 revisar la V74 debe ser 1
        if (typeof this.data.v85 !== 'undefined' && this.data.v85.id === '2' && typeof this.data.v74 !== 'undefined' && this.data.v74.id !== '1') {
          this.errors.push('la V85 es 2 revisar la V74 debe ser 1')
          this.error = true
        }

        if (typeof this.data.v85 !== 'undefined' && this.data.v85.id === '2' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '10' && this.data.v128.id !== '4') {
          this.errors.push('La V128 es = 10 o 4 revisar la V85 debe ser 2')
          this.error = true
        }

        if (typeof this.data.v86 !== 'undefined' && this.data.v86.id === '1') {
          if (typeof this.data.v88 !== 'undefined' && this.data.v88 !== '1845-01-01') {
            this.errors.push('La V88 es <> 1845-01-01 revisar la V86 debe ser 1')
            this.error = true
          }
          if (typeof this.data.v89 !== 'undefined' && parseInt(this.data.v89.id) > 13) {
            this.errors.push('La V89 es <= 12 revisar la V86 debe ser 1')
            this.error = true
          }
          if (typeof this.data.v87 !== 'undefined' && parseInt(this.data.v87) > 70) {
            this.errors.push('La V87 es <= 70 revisar la V86 debe ser 1')
            this.error = true
          }

          if (typeof this.data.v91 !== 'undefined' && (parseInt(this.data.v91) < 1 || parseInt(this.data.v91) > 5)) {
            this.errors.push('La V91 es >= 1 y <= 5 revisar la V86 debe ser 1')
            this.error = true
          }

          if (typeof this.data.v92 !== 'undefined' && this.data.v92 !== '98') {
            this.errors.push('La V92 es <> 98 revisar la V86 debe ser 1')
            this.error = true
          }
          if (typeof this.data.v90 !== 'undefined' && this.data.v90.id !== '98') {
            this.errors.push('La V90 es <> 98 revisar la V86 debe ser 1')
            this.error = true
          }
          if (typeof this.data.v94 !== 'undefined' && this.data.v94 !== '1800-01-01') {
            if (typeof this.data.v94 !== 'undefined' && Date.parse(this.data.v94) < Date.parse('2020-01-02')) {
              this.errors.push('La V94 es 1800-01-01 o >= 2021-01-02 revisar la V86 debe ser 1')
              this.error = true
            }
          }
        }

        if (typeof this.data.v86 !== 'undefined' && this.data.v86.id === '98') {
          if (typeof this.data.v87 !== 'undefined' && this.data.v87.id !== '98') {
            this.errors.push('La V87 es 98 revisar la V86 debe ser 98')
            this.error = true
          }

          // Validacion dos
          if (typeof this.data.v88 !== 'undefined' && this.data.v88 !== '1845-01-01') {
            this.errors.push('La V88 es 1845-01-01 revisar la V86 debe ser 98')
            this.error = true
          }

          // Validacion tres
          if (typeof this.data.v89 !== 'undefined' && this.data.v89.id !== '98') {
            this.errors.push('La V89 es 98 revisar la V86 debe ser 98')
            this.error = true
          }

          // Validacion cuatro
          if (typeof this.data.v90 !== 'undefined' && this.data.v90.id !== '98') {
            this.errors.push('La V90 es 98 revisar la V86 debe ser 98')
            this.error = true
          }

          if (typeof this.data.v91 !== 'undefined' && this.data.v91 !== '98') {
            this.errors.push('La V91 es 98 revisar la V86 debe ser 98')
            this.error = true
          }

          if (typeof this.data.v92 !== 'undefined' && this.data.v92 !== '98') {
            this.errors.push('La V92 es 98 revisar la V86 debe ser 98')
            this.error = true
          }

          if (typeof this.data.v93 !== 'undefined' && this.data.v93 !== '98') {
            this.errors.push('La V93 es 98 revisar la V86 debe ser 98')
            this.error = true
          }

          if (typeof this.data.v94 !== 'undefined' && this.data.v94 !== '1845-01-01') {
            this.errors.push('La V94 es 1845-01-01 revisar la V86 debe ser 98')
            this.error = true
          }

          if (typeof this.data.v95 !== 'undefined' && this.data.v95.id !== '98') {
            this.errors.push('La V95 es 98 revisar la V86 debe ser 98')
            this.error = true
          }

          if (typeof this.data.v96 !== 'undefined' && this.data.v96.id !== '98') {
            this.errors.push('La V96 es 98 revisar la V86 debe ser 98')
            this.error = true
          }
          if (typeof this.data.v97 !== 'undefined' && this.data.v97 !== '1845-01-01') {
            this.errors.push('La V97 es 1845-01-01 revisar la V86 debe ser 98')
            this.error = true
          }

          if (typeof this.data.v98 !== 'undefined' && this.data.v98.id !== '98') {
            this.errors.push('La V98 es 98 revisar la V86 debe ser 98')
            this.error = true
          }

          if (typeof this.data.v99 !== 'undefined' && this.data.v99.id !== '98') {
            this.errors.push('La V99 es 98 revisar la V86 debe ser 98')
            this.error = true
          }

          if (typeof this.data.v100 !== 'undefined' && this.data.v100 !== '98') {
            this.errors.push('La V100 es 98 revisar la V86 debe ser 98')
            this.error = true
          }

          if (typeof this.data.v101 !== 'undefined' && this.data.v101 !== '98') {
            this.errors.push('La V101 es 98 revisar la V86 debe ser 98')
            this.error = true
          }

          if (typeof this.data.v102 !== 'undefined' && this.data.v102 !== '98') {
            this.errors.push('La V102 es 98 revisar la V86 debe ser 98')
            this.error = true
          }

          if (typeof this.data.v103 !== 'undefined' && this.data.v103 !== '1845-01-01') {
            this.errors.push('La V103 es 1845-01-01 revisar la V86 debe ser 98')
            this.error = true
          }

          if (typeof this.data.v104 !== 'undefined' && this.data.v104.id !== '98') {
            this.errors.push('La V104 es 98 revisar la V86 debe ser 98')
            this.error = true
          }

          if (typeof this.data.v105 !== 'undefined' && this.data.v105.id !== '98') {
            this.errors.push('La V105 es 98 revisar la V86 debe ser 98')
            this.error = true
          }
        }

        if (typeof this.data.v87 !== 'undefined' && this.data.v87 !== '555' && this.data.v87 !== '98') {
          if (typeof this.data.v87 !== 'undefined' && parseInt(this.data.v87) > 70) {
            this.errors.push('La V87 debe ser <= 70 o 555 o 98')
            this.error = true
          }
        }

        if (typeof this.data.v87 !== 'undefined' && this.data.v87 === '98' && typeof this.data.v86 !== 'undefined' && this.data.v86.id !== '98') {
          this.errors.push('La V87 es 98, revisar la V86 debe ser 98')
          this.error = true
        }

        if (typeof this.data.v87 !== 'undefined' && parseInt(this.data.v87) <= 70 && typeof this.data.v86 !== 'undefined' && this.data.v86.id !== '1') {
          this.errors.push('La V87 es <= 70, revisar la V86 debe ser 1')
          this.error = true
        }

        // Validación 1
        if (typeof this.data.v88 !== 'undefined' && this.data.v88 !== '1845-01-01' && this.data.v88 !== '1846-01-01') {
          // Validación 2
          if (typeof this.data.v88 !== 'undefined' && typeof this.data.v18 !== 'undefined' && typeof this.data.v134 !== 'undefined' && (Date.parse(this.data.v88) < Date.parse(this.data.v18) || Date.parse(this.data.v88) > Date.parse(this.data.v134))) {
            this.errors.push('La V134 >= V88 y V18 < V88 o = V88 = 1845-01-01 o 1846-01 01')
            this.error = true
          }
        }

        // validación 1
        if (typeof this.data.v88 !== 'undefined' && this.data.v88 === '1845-01-01' && typeof this.data.v86 !== 'undefined' && this.data.v86.id !== '1') {
          this.errors.push('La V88 es 1845-01-01 revisar la V86 debe ser <> 1')
          this.error = true
        }

        // validación 2
        if (typeof this.data.v88 !== 'undefined' && typeof this.data.v87 !== 'undefined' && this.data.v88 === '1845-01-01' && this.data.v97 !== '1845-01-01') {
          this.errors.push('La V97 es 1845-01-01 revisar la V88 ser 1845-01-01')
          this.error = true
        }

        if (typeof this.data.v88 !== 'undefined' && typeof this.data.v18 !== 'undefined' && Date.parse(this.data.v88) > Date.parse('1846-01-01') && Date.parse(this.data.v88) < Date.parse(this.data.v18)) {
          this.errors.push('La V88 es > 1846-01-01 revisar la V88 debe ser >= v18')
          this.error = true
        }

        if (typeof this.data.v88 !== 'undefined' && Date.parse(this.data.v88) > Date.parse('1846-01-01') && typeof this.data.v86 !== 'undefined' && this.data.v86.id !== '1') {
          this.errors.push('La V88 es > 1846-01-01 revidar  la C86 debe ser = 1')
          this.error = true
        }

        if (typeof this.data.v89 !== 'undefined' && parseInt(this.data.v89.id) <= 13) {
          if (typeof this.data.v86 !== 'undefined' && this.data.v86.id !== '1') {
            this.errors.push('La V89 es <= 13 revisar la V86 debe ser 1')
            this.error = true
          }
        }

        if (typeof this.data.v89 !== 'undefined' && this.data.v89.id === '98') {
          if (this.data.v87 !== '98' && this.data.v87 !== '97') {
            this.errors.push('La V89 es 98 lreviar la V87 debe ser 98 o 97')
            this.error = true
          }
        }

        if (typeof this.data.v89 !== 'undefined' && this.data.v89.id !== '98') {
          if (typeof this.data.v88 !== 'undefined' && typeof this.data.v87 !== 'undefined' && parseInt(this.data.v87) < 70 && this.data.v87 !== '555') {
            this.errors.push('La V89 es <> 98 revisar la V87 debe ser < 70 o = 555')
            this.error = true
          }
        }

        if (typeof this.data.v90 !== 'undefined' && this.data.v90.id !== '98' && typeof this.data.v86 !== 'undefined' && this.data.v86.id !== '1') {
          this.errors.push('La V90 es <> 98 revisar la V86 debe ser 1')
          this.error = true
        }

        if (typeof this.data.v90 !== 'undefined' && this.data.v90.id === '98' && typeof this.data.v86 !== 'undefined' && this.data.v86.id !== '98') {
          this.errors.push('La V90 es 98 revisar la V86 debe ser 98')
          this.error = true
        }

        if (typeof this.data.v87 !== 'undefined' && this.data.v87 !== '98' && this.data.v87 !== '55') {
          if (typeof this.data.v87 !== 'undefined' && parseInt(this.data.v87) > 5) {
            this.errors.push('La V87 debe ser <= 70 o 555 o 98')
            this.error = true
          }
        }

        if (typeof this.data.v91 !== 'undefined' && typeof this.data.v93 !== 'undefined' && this.data.v91 === '1' && this.data.v93 !== '98') {
          this.errors.push('La V93 es 98 revisar la V91 debe ser 1')
          this.error = true
        }

        if (typeof this.data.v91 !== 'undefined' && this.data.v91 === '55' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 es 14 revisar la V91 debe ser 55')
          this.error = true
        }

        if (typeof this.data.v91 !== 'undefined' && parseInt(this.data.v91) <= 5 && typeof this.data.v86 !== 'undefined' && this.data.v86.id !== '1') {
          this.errors.push('La V91 <= 5 revisar la V86 debe ser 1')
          this.error = true
        }

        if (typeof this.data.v91 !== 'undefined' && this.data.v91 === '98' && typeof this.data.v86 !== 'undefined' && this.data.v86.id !== '98' && this.data.v86.id !== '2') {
          this.errors.push('La V91 es 98 revisar la V86 debe ser 98 o 2')
          this.error = true
        }

        if (typeof this.data.v91 !== 'undefined' && typeof this.data.v87 !== 'undefined' && this.data.v91 !== '98' && parseInt(this.data.v87) < 97 && this.data.v87 !== '555') {
          this.errors.push('La V91 es <> 98 revisar la V87 debe ser <97 o = 555')
          this.error = true
        }

        // validación 1
        if (typeof this.data.v91 !== 'undefined' && typeof this.data.v93 !== 'undefined' && parseInt(this.data.v91) >= 2 && parseInt(this.data.v91) < 98 && this.data.v93 === '98') {
          this.errors.push('La V93 es <> 98 revisar la V91 debe der >= 2 y < 98')
          this.error = true
        }

        if (typeof this.data.v98 !== 'undefined' && parseInt(this.data.v92) > 98 && typeof this.data.v86 !== 'undefined' && this.data.v86.id !== '1') {
          this.errors.push('LA V92 es >98 revisar la V86 debe ser 1')
          this.error = true
        }

        if (typeof this.data.v92 !== 'undefined' && this.data.v92 !== '98') {
          if (typeof this.data.v87 !== 'undefined' && parseInt(this.data.v87) > 70 && this.data.v87 !== '555') {
            this.errors.push('La V92 es <> 98 revisar la V87 debe se <70  o = 555')
            this.error = true
          }
        }

        if (typeof this.data.v98 !== 'undefined' && this.data.v93 !== '98') {
          if (typeof this.data.v87 !== 'undefined' && parseInt(this.data.v87) > 1 && parseInt(this.data.v87) < 97 && this.data.v87 !== '555') {
            this.errors.push('La V93 es <> 98 revisar la V87 debe ser > 1 y < 97 o = 555')
            this.error = true
          }
        }

        if (typeof this.data.v93 !== 'undefined' && parseInt(this.data.v93) > 98 && typeof this.data.v86 !== 'undefined' && this.data.v86.id !== '1') {
          this.errors.push('La V93 es > 98 revisar la V86 debe der 1')
          this.error = true
        }

        if (typeof this.data.v94 !== 'undefined' && this.data.v94 !== '1800-01-01' && this.data.v94 !== '1845-01-01' && this.data.v94 !== '1846-01-01') {
          if (typeof this.data.v94 !== 'undefined' && typeof this.data.v134 !== 'undefined' && (Date.parse(this.data.v94) < Date.parse('2021-01-01') || Date.parse(this.data.v94) > Date.parse(this.data.v134))) {
            this.errors.push('La V94 debser <= 134 y >= 2021-01-01 y >= V88 o 1800-01-01 o 1845-01-01 o 1846-01-01')
            this.error = true
          }

          if (typeof this.data.v94 !== 'undefined' && typeof this.data.v88 !== 'undefined' && Date.parse(this.data.v94) < Date.parse(this.data.v88)) {
            this.errors.push('La V94 debser <= 134 y >= 2021-01-01 y >= V88 o 1800-01-01 o 1845-01-01 o 1846-01-01')
            this.error = true
          }
        }
        ...
        if (typeof this.data.v94 !== 'undefined' && this.data.v94 === '1800-01-01') {
          if (typeof this.data.v86 !== 'undefined' && this.data.v86.id !== '1') {
            this.errors.push('LA v94 es 1800-01-01 revisar la V86 debe ser 1')
            this.error = true
          }
          if (typeof this.data.v88 !== 'undefined' && Date.parse(this.data.v88) < Date.parse('1846-01-01')) {
            this.errors.push('LA v94 es 1800-01-01 revisar la V88 debe ser > 1846-01-01')
            this.error = true
          }
          if (typeof this.data.v95 !== 'undefined' && this.data.v95.id !== '3') {
            this.errors.push('LA V95 es 3 revisar la V94 debe ser 1800-01-01')
            this.error = true
          }
          if (typeof this.data.v95 !== 'undefined' && this.data.v95.id !== '98') {
            this.errors.push('LA V96 es 98 revisar la V94 debe ser1800-01-01')
            this.error = true
          }
          if (typeof this.data.v97 !== 'undefined' && this.data.v97 !== '1845-01-01') {
            this.errors.push('La V97 es 1845-01-01 revisar la V94 debe ser 1800-01-01')
            this.error = true
          }
        }

        if (typeof this.data.v94 !== 'undefined' && this.data.v94 === '1846-01-01' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 es 14 revisar la V94 debe ser 1846-01-01')
          this.error = true
        }

        if (typeof this.data.v94 !== 'undefined' && typeof this.data.v88 !== 'undefined' && Date.parse(this.data.v94) >= Date.parse('2021-01-02') && Date.parse(this.data.v88) > Date.parse(this.data.v94)) {
          this.errors.push('La V94 es >= 2021-01-02 revisar la V88 debe ser <= V94')
          this.error = true
        }

        if (typeof this.data.v95 !== 'undefined' && this.data.v95.id === '1' && typeof this.data.v96 !== 'undefined' && this.data.v96.id !== '98') {
          this.errors.push('La V96 es 98 revisar la V95 debe ser 1')
          this.error = true
        }

        // validación 2
        if (typeof this.data.v95 !== 'undefined' && this.data.v95.id === '3' && this.data.v94 !== '1800-01-01') {
          this.errors.push('La V945 es 3 reviar la V94 debe ser 1800-01-01')
          this.error = true
        }

        // validación 3
        if (typeof this.data.v95 !== 'undefined' && this.data.v95.id === '3' && typeof this.data.v96 !== 'undefined' && this.data.v96.id !== '98') {
          this.errors.push('La V96 es 98 revisar la V95 debe ser 3')
          this.error = true
        }

        // validación 4
        if (typeof this.data.v95 !== 'undefined' && this.data.v95.id === '3' && typeof this.data.v98 !== 'undefined' && this.data.v98.id !== '98') {
          this.errors.push('La v98 es 98 revisar la V95 debe ser 3')
          this.error = true
        }

        if (typeof this.data.v95 !== 'undefined' && this.data.v95.id === '55' && typeof this.data.v128 !== 'undefined' && this.data.v128.id !== '14') {
          this.errors.push('La V128 es 14 revisar la V95 debe ser 55')
          this.error = true
        }

        if (typeof this.data.v95 !== 'undefined' && parseInt(this.data.v95.id) <= 3 && typeof this.data.v86 !== 'undefined' && this.data.v86.id !== '1') {
          this.errors.push('LA V95 es 55 revisar la V86 debe ser 1')
          this.error = true
        }

        if (typeof this.data.v95 !== 'undefined' && this.data.v95.id === '98' && typeof this.data.v86 !== 'undefined' && this.data.v86.id !== '98') {
          this.errors.push('LA V95 es 98 revisar la V86 debe ser98')
          this.error = true
        }

        if (typeof this.data.v95 !== 'undefined' && this.data.v95.id === '98' && typeof this.data.v96 !== 'undefined' && this.data.v96.id !== '98') {
          this.errors.push('La V96 es 98 revisar la V95 debe ser 98')
          this.error = true
        }

        if (typeof this.data.v95 !== 'undefined' && this.data.v95.id === '2' && typeof this.data.v96 !== 'undefined' && parseInt(this.data.v96.id) > 7) {
          this.errors.push('La V96 es <=7  o la V94 es >2021-01-02 revisar  la V95 debe ser 2')
          this.error = true
        }

        // Validación 2
        if (typeof this.data.v95 !== 'undefined' && this.data.v95.id === '2' && Date.parse(this.data.v94) < Date.parse('2021-01-02')) {
          this.errors.push('La V96 es <=7  o la V94 es >2021-01-02 revisar  la V95 debe ser 2')
          this.error = true
        }

        if (typeof this.data.v95 !== 'undefined' && this.data.v95.id !== '98' && this.data.v87 === '98') {
          this.errors.push('La V95 es <> 98 revisar la V87 debe ser <> 98')
          this.error = true
        }
