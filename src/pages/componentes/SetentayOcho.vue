            ...
            <h4 class="titulo_fondo w_100">Intervenciones de prevención en la persona que vive con VIH</h4>
              ...
              <div class="row dos_items">
                  <div class="item-numero">
                      ...
                      <q-select rounded standout v-model="data.numeroCondonesAño" :options="numeroCondonesAño" label="Seleccionar" />
                  </div>
                  <div class="item">
              ...
              <div class="row dos_items">
                  ...
                  <div class="item-numero">
                      ...
                      <q-select rounded standout v-model="data.evaluacionCardiovascularViveVih" :options="evaluacionCardiovascularViveVih" label="Seleccionar" />
                  </div>
              </div>
